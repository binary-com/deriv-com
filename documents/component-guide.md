...
-   Do refer to [typography.js](https://github.com/binary-com/deriv-com/blob/master/src/components/elements/typography) for the breakdown of different sizing across desktop and mobile
