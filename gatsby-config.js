...
const isBetaDomain = process.env.GATSBY_DOMAIN === 'beta.deriv.com'

const robotsTxtPluginConfig = {
    resolve: 'gatsby-plugin-robots-txt',
    options: {
        host: isBetaDomain ? 'https://beta.deriv.com' : 'https://deriv.com',
        policy: [
            {
                userAgent: '*',
                allow: isBetaDomain ? null : '/',
                disallow: isBetaDomain
                    ? ['/']
                    : [
                          '/404/',
                          '/homepage/',
...
plugins.push(robotsTxtPluginConfig)
