...
export const move_to_dmt5_non_eu_url = 'https://deriv.com/dmt5/'
export const move_to_dmt5_is_eu_url = 'https://eu.deriv.com/dmt5/'
export const move_to_dmt5_is_uk_url = 'https://uk.deriv.com/dmt5/'
export const move_to_dtrader_non_eu_url = 'https://deriv.com/dtrader/'
export const move_to_dtrader_is_eu_url = 'https://eu.deriv.com/dtrader/'
export const move_to_dtrader_is_uk_url = 'https://uk.deriv.com/dtrader/'
export const move_to_explore_non_eu_url = 'https://deriv.com/'
export const move_to_explore_is_eu_url = 'https://eu.deriv.com/'
export const move_to_explore_is_uk_url = 'https://uk.deriv.com/'
