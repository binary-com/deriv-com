...
export const smart_trader_languages = ['es', 'fr', 'id', 'it', 'pl', 'pt', 'ru', 'vi', 'zh_cn', 'zh_tw'];
...
export const dmt5_ios_url = 'https://download.mql5.com/cdn/mobile/mt5/ios?server=Deriv-Demo,Deriv-Server';
export const dmt5_android_url = 'https://download.mql5.com/cdn/mobile/mt5/android?server=Deriv-Demo,Deriv-Server';
export const dmt5_linux_url = 'https://www.metatrader5.com/en/terminal/help/start_advanced/install_linux';
...
export const dmt5_mac_app_url = 'https://download.mql5.com/cdn/web/metaquotes.software.corp/mt5/MetaTrader5.dmg';
export const dmt5_windows_download_url =
    'https://download.mql5.com/cdn/web/metaquotes.software.corp/mt5/mt5setup.exe?utm_source=www.metatrader5.com&utm_campaign=download';
export const dmt5_app_gallery =
    'https://download.mql5.com/cdn/mobile/mt5/android/app-gallery?hl=en&utm_source=www.metatrader5.com&utm_campaign=install.metaquotes';
export const dmt5_windows_url = 'https://download.mql5.com/cdn/web/deriv.limited/mt5/deriv5setup.exe';
export const dp2p_google_play_url = 'https://play.google.com/store/apps/details?id=com.deriv.dp2p&hl=en&gl=US';
