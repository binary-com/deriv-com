...
const SocketCache = (() => {
    ...
    const config = {
        ...
        active_symbols: {
            expire: 10,
            // map_to: ['product_type', 'landing_company', getLanguage],
            map_to: ['product_type', 'landing_company', 'en'],
        },
        contracts_for: {
            expire: 10,
            map_to: ['contracts_for', 'product_type', 'currency'],
        },
