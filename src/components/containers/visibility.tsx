...
export const getCountryRule = () => {
    ...
    const is_eu_test_link =
        isBrowser() && localStorage.getItem('config.test_link_base_domain') === 'eu.deriv.com'
    ...
    const is_eu =
        is_eu_residence || (!residence && is_eu_country) || is_eu_domain || is_eu_test_link
