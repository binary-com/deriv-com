...
// SVG
import AffiliateIb from 'images/svg/menu/menu_affiliate_ib.svg'
import Blog from 'images/svg/components/component_blog_nav.svg'
import Career from 'images/svg/menu/menu_careers.svg'
import Choose from 'images/svg/menu/menu_choose.svg'
import Commodities from 'images/svg/components/component_commodities_nav.svg'
import Community from 'images/svg/menu/menu_community.svg'
import Contact from 'images/svg/menu/menu_contact.svg'
import DerivedFX from 'images/svg/components/component_derived_fx.svg'
import DerivLife from 'images/svg/menu/menu_deriv_life.svg'
import { DbotIcon } from 'images/svg/dbot'
import BinaryBot from 'images/svg/binarybot-icon.svg'
import API from 'images/svg/menu/menu_developers.svg'
import Diagonal from 'images/svg/elements/elements_pink_right_diagonal.svg'
import DMT5 from 'images/svg/dmt5/dmt5_icon.svg'
import DerivX from 'images/svg/components/component_deriv_x.svg'
import { DerivEzLogoRed } from 'images/svg/deriv-ez'
import DTrader from 'images/svg/dtrader/dtrader_icon.svg'
import DerivGo from 'images/svg/components/component_deriv_go_icon.svg'
import Forex from 'images/svg/components/component_forex_nav.svg'
import Help from 'images/svg/menu/menu_help_center.svg'
import CFD from 'images/svg/components/component_margin_trading_nav.svg'
import Multipliers from 'images/svg/components/component_multipliers_nav.svg'
import Options from 'images/svg/components/component_options_nav.svg'
import Partner from 'images/svg/menu/menu_partner.svg'
import Payment from 'images/svg/menu/menu_payment_methods.svg'
import PaymentAgent from 'images/svg/menu/menu_payment_agent.svg'
import BugBounty from 'images/svg/menu/menu_bug_bounty.svg'
import Regulatory from 'images/svg/menu/menu_regulatory.svg'
import SecureTrading from 'images/svg/menu/menu_secure_trading.svg'
import Smarttrader from 'images/svg/components/component_smart_trader.svg'
import Status from 'images/svg/elements/elements_status.svg'
import StockIndices from 'images/svg/components/component_stock_indices_nav.svg'
import Cryptocurrencies from 'images/svg/components/component_cryptocurrencies_nav.svg'
import Story from 'images/svg/menu/menu_story.svg'
import Terms from 'images/svg/menu/menu_terms.svg'
import Trade from 'images/svg/components/component_trader_tool_nav.svg'
import Signals from 'images/svg/menu/menu_signals.svg'
