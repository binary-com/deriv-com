    ...
    switch (type) {
        case 'main':
            return {
                ...
                markets: ['markets'],
                about: ['story', 'regulatory', 'why-choose-us', 'partners', 'contact_us', 'careers', 'who-we-are'],
                resources: ['help-centre', 'trader-tools', 'payment-methods', 'dmt5-trading-signals', 'blog'],
            };
        case 'careers':
            return {
                home: ['careers'],
