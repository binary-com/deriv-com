        ...
        <>
            <DisclaimerWrapper>
                ...
                <Show.Eu>
                    ...
                    <DisclaimerParagraph>
                        <Localize
                            translate_text="Deriv (MX) Ltd, Millennium House, Level 1, Victoria Road, Douglas IM2 4RW, Isle of Man, is licensed and regulated in the United Kingdom by the UK Gambling Commission (<1>account no. 39172</1>)."
                            components={[
                                <StaticAsset
                                    key={0}
                                    target="_blank"
