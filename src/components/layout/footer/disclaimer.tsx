...
import { DisclaimerWrapper, DisclaimerParagraph, StaticAsset, RiskWarning, BoldLink } from './common/style';
                            ...
                            <>
                                ...
                                <DisclaimerParagraph>
                                    <Localize
                                        ...
                                        components={[
                                            <BoldLink key={0} target='_blank' to='/terms-and-conditions/#clients' />,
                                            <StaticAsset key={1} target='_blank' href='/tnc/risk-disclosure.pdf' />,
                            ...
                            <>
                                ...
                                <DisclaimerParagraph>
                                    <Localize
                                        ...
                                        components={[
                                            <BoldLink key={0} target='_blank' to='/terms-and-conditions/#clients' />,
                                            <StaticAsset key={1} target='_blank' href='/tnc/risk-disclosure-eu.pdf' />,
                                            <BoldLink key={2} target='_blank' to='/responsible/' />,
                                        ]}
                                    />
                                </DisclaimerParagraph>
