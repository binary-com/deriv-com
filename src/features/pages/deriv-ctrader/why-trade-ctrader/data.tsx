...
import { TradingPlatformWhyTradeProps } from 'features/components/templates/trading-platform/types'
...
export const trading_platform_why_trade: TradingPlatformWhyTradeProps = {
