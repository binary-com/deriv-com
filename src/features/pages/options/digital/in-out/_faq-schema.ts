    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    '_t_You can place an In/Out trade by: - Choosing your preferred instrument to trade. - Specifying the duration of the trade - Setting the upper and lower price boundaries. - Entering your stake or preferred potential payout amount. - Placing the trade._t_',
                ),
            },
        },
        {
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    `_t_Payouts for all In/Out contracts are fixed, based on: - Trade duration - Barrier levels- Market conditions
                    ...
                    With narrower barriers, the price has less room to move. So, potential payouts are often higher due to a lower probability of the price staying between the barriers._t_`,
                ),
            },
        },
    ],
