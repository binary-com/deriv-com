    ...
    return (
        <DigitalOptionsLayout>
            <Typography.Paragraph pb="20x">
                <Localize translate_text="_t_Lookbacks that allow you to earn a payout depending on the optimum high or low achieved by the market during the duration of a contract._t_" />
