    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    "_t_<p>Reset Call/Reset Put contracts offer the ability to reset the strike price at a potentially more advantageous level. In this contract, your market prediction is your contract's exit price against the reset price (instead of the entry price). Reset contract types also typically offer offer a lower fixed payout percentage compared to Rise/Fall contracts.</p><p> Meanwhile, Rise/Fall contracts consider the contract's exit price against the contract's entry price, based on your market prediction.</p><p>In both instances, the potential payout is fixed upon entry.</p>_t_",
                ),
            },
        },
        {
