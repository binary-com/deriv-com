    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    `_t_<p>The potential payout is predetermined based on the specific details of the trade and if your market predictions are right.</p>
                    <p>For Rise/Fall contracts, potential payouts generally range from 85% to 95% of your stake.</p>
                    <p>For Higher/Lower contracts, potential payouts can range from 1% to 3,900% of your stake, depending on where the barrier is set.</p>
                    <p>The potential payout and potential loss (your initial stake) will be clearly displayed before you enter the trade.</p>_t_`,
                ),
            },
        },
        {
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    `_t_<p>No, they are not the same.</p>
                    <p>When you trade a Higher/Lower contract, you speculate on the price direction of an underlying asset over a time period.</p>
                    <p>When you trade High/Low Ticks, you predict which tick is the highest within a 5-tick contract.</p>_t_`,
                ),
            },
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    `_t_<p>Traders typically analyse the underlying market and price trends to determine the likelihood of prices rising or falling over a given time period.</p>
                    <p>To identify trends, you can consider a number of factors, including:</p><ul><li> - Recent price swings and market volatility</li><li> - Economic news and events</li><li> - Trends revealed by using technical indicators.</li></ul>_t_`,
                ),
            },
        },
    ],
