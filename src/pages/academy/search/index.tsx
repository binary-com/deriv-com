...
const SearchPage = () => {
    ...
    const { academy_data, academy_blog_image_data, academy_video_image_data } =
    ...
    const combined_academy_video_data = academy_data.videos.map((item, i) =>
        Object.assign({}, item, academy_video_image_data.videos[i]),
    )

    const combined_data = [...combined_academy_blog_data, ...combined_academy_video_data]
