...
const Footer = () => (
    <>
        <FooterWrapper>
            <Container direction="column" jc="flex-start" ai="flex-start">
                <Text>
                ...
                <Text mt="0.8rem">
                    This website&apos;s services are not made available in certain countries
                    including the USA, Canada, Hong Kong, and Japan, or to persons below 18.
                </Text>
                <Flex mt="2.4rem" mb="0.8rem" ai="center" width="auto" jc="flex-start">
