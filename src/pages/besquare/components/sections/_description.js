    ...
    <SectionContainer color={'white'} padding={'0'}>
        <Container>
            ...
            >
                ...
                <strong>from innovative IT teams</strong> in an established, global FinTech company.
                If you’re exceptional at embracing BESQUARE challenges and our company values,
                you’ll get an immediate job offer from Deriv at the end of the programme.
            </TextWrapper>
        </Container>
    </SectionContainer>
)
