...
export default [
    ...
    },
    {
        ...
        content: [
            {
                title: ' Just adding dummy details',
                subtitle: ' Dummy again',
            },
            {
                title: 'Test another dummy',
                subtitle: (
                    <p>
                        You can contact us via the email belowbla2
                        <Link href="mailto:umithra@binary.com">Email</Link>
                    </p>
                ),
            },
        ],
