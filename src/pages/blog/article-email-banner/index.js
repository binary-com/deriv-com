...
import { TextWrapper } from '../components/_common'
...
// can delete this dummyarticlelayout when merge with other components
const DummyArticleLayout = styled(Flex)`
    max-width: 300px;
    padding: 8rem 0;
    margin-left: 8rem;
...
export default WithIntl()(ArticleEmailBanner)
