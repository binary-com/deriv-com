...
const GetEbook = ({ onSubmit, ebook_utm_code }) => {
    ...
    const [ _cio ] = useState(_cio || [])
    const url = 'https://assets.customer.io/assets/track.js';
    useEffect(() => {
        const t = document.createElement('script');
        const v1 = document.createElement('script');
        const s1 = document.createElement('script');
        const v = 'var _cio = _cio || [];'
        const s = 'var a,b,c;a=function(f){return function(){_cio.push([f].concat(Array.prototype.slice.call(arguments,0)))}};b=["load","identify","sidentify","track","page"];for(c=0;c<b.length;c++){_cio[b[c]]=a(b[c])};'
        v1.innerHTML = v
        s1.innerHTML = s
        t.src = url;
        t.async = true;
