            ...
            <MainWrapper>
                <Carousel has_autoplay autoplay_interval={60000000} {...settings}>
                    <Hero
                        ...
                        description={localize('Our 6-month programme aims to make fresh graduates attractive to hiring managers by providing them with square-shaped skills, mentorship, and a once-in-a-lifetime work experience.')}
                    />
                    <Hero
                        heroImage={data['hero_image_two']}
                        title={localize('This week’s market report')}
                        description={localize('We give our 2 satoshis about the crypto market outlook, and talk about the performance of other markets in the past week. ')}
                    />
                    <Hero
                        heroImage={data['hero_image_three']}
                        title={localize('Free ebook: How to trade stocks the smart way')}
                        description={localize('Today, financial markets are open to everyone, not just the financial elite. This ebook by Vince Stanzione teaches you how you can trade stocks just like the pros.')}
                    />
                </Carousel>
            </MainWrapper>
        </Layout>
