        ...
        <Container>
            <WrapContainer p='8rem 0' tablet={{ p: '40px 0' }}>
                <WrapText direction='column' max_width='38.4rem' tablet={{ max_width: '100%' }}>
                    ...
                    <Header type='paragraph-1' weight='normal' as='p' mb='16px' laptopM={{ mb: '14px' }}>
                ...
                <ImageWrapper>
                    <QueryImage
                        ...
                        alt={localize(
                            '_t_Send us an email with the report of a bug you found on Deriv trading platforms or apps._t_'
                        )}
                        loading='eager'
                    />
                </ImageWrapper>
