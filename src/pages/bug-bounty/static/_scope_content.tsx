...
export const scope_content = [
    {
        ...
        check_list: [
            ...
            {
                content: <Localize translate_text='Our WebSockets API: *.binaryws.com api.deriv.com' />,
            },
            {
                content: (
                    <Localize
                        translate_text='Our main trading platform: app.deriv.com<0>*</0>'
                        components={[<Header key={0} type='paragraph-2' as='span' color='red' weight='normal' />]}
                    />
                ),
                description: (
                    <Localize
                        translate_text='<0>*</0>This only covers the functionalities handled by Deriv'
                        components={[<Header as='span' color='red' type='small' weight='normal' key={0} />]}
                    />
                ),
            },
            {
                content: <Localize translate_text='Our legacy trading platform: smarttrader.deriv.com' />,
            },
        ],
    },
    {
        ...
        check_list: [
            ...
            {
                content: <Localize translate_text='Our CFD trading application by Devexperts: dx.deriv.com' />,
            },
            {
                content: (
                    <Localize
            ...
            {
                content: <Localize translate_text='Our site for marketing campaigns: trade.deriv.com (third-party)' />,
            },
        ],
    },
    {
        ...
        check_list: [
            {
                content: <Localize translate_text='Our site for static resources: static.deriv.com' />,
            },
            { content: <Localize translate_text='Our tracking site: t.deriv.com' /> },
            {
                content: <Localize translate_text='Our FIX feed server for Deriv X: fix.deriv.com' />,
            },
            { content: <Localize translate_text='Our internal apps: *.deriv.cloud' /> },
            {
                content: <Localize translate_text='Our weblog address: https://blog.deriv.com/' />,
            },
        ],
    },
    {
        ...
        check_list: [
            ...
            {
                content: <Localize translate_text='Our graduate programme site: besquare.deriv.com' />,
            },
            {
                content: <Localize translate_text='Our CFD trading platform by MetaQuotes: trade.mql5.com' />,
            },
