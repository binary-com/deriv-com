...
export const front_end_positions = [
    {
        ...
        responsibilities: [
            localize('Be meticulous, organised, results-driven, and proactive.'),
            localize(
        ...
        qualifications: [
            localize('Extensive experience of JavaScript, HTML, and CSS'),
            localize(
        ...
        preferences: [
            localize('Knowledge of information security and data protection'),
            localize('Experience in responsive and mobile web design'),
            localize('Good grasp of user experience and user interface design'),
            localize('Familiarity in search engine optimisation (SEO)'),
            localize('Knowledge of back-end technologies'),
        ],
    },
    {
        ...
        responsibilities: [
            ...
            localize('Analyse, enhance, and support our existing mobile applications.'),
            localize(
                'Work closely with QA, Design, and Product Management teams to build the best possible UX for our mobile apps',
            ),
        ],
        qualifications: [
            localize('Experience in Flutter framework or a keen eagerness to master it'),
            localize(
            ...
            localize('Distinct competence in mobile app development for at least one platform'),
            localize(
