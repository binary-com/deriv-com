...
export const hr_recruitment_positions = [
    {
        ...
        qualifications: [
            localize('A university degree in a related field'),
            localize('Minimum 5 years of progressive senior HR experience'),
            localize('Complete familiarity with organisational behaviour'),
            localize(
                'Demonstrable experience in analytical and data management and exceptional skill in translating data into action planning',
            ),
            localize('Well-developed coaching, communication, and leadership skills'),
            localize(
                'Strongly capable of showing empathy and handling sensitive situations with tact and finesse',
            ),
            localize('Excellent knowledge of HR systems and databases'),
            localize('Highly adept at making quick, informed decisions '),
            localize('Exceptional English communication skills (both oral and written)'),
            localize('Experience in working for an international company\n'),
        ],
    },
    {
        ...
        responsibilities: [
            ...
            localize('Administer human resource activities such as performance appraisals.'),
            localize(
                'Provide administrative support to all internal departments, including sourcing vendors\nand planning events.',
            ),
            localize('Manage office expenses and petty cash'),
        ],
        qualifications: [
            localize('Advanced/higher/graduate diploma or university degree'),
            localize(
                'Extensive experience with Microsoft Office applications, as well as popular HR management and payroll systems',
            ),
            localize('Sharp administrative and accounting skills'),
            localize(
    ...
    },
    {
        ...
        responsibilities: [
            ...
            localize('Manage office budgets and expenditure.'),
            localize('Oversee and improve general administrative processes.'),
            localize(
            ...
            localize('Be the first point of contact for our vendors and contractors.'),
            localize(
                'Organise company events, team building activities, and company trips and perform ad hoc tasks as required.',
            ),
        ],
        qualifications: [
            localize('An advanced diploma or bachelor’s degree'),
            localize('Employment history in accounting, administration, or marketing'),
            localize('Commendable experience in project management '),
            localize('Extensive experience in Microsoft Office applications'),
            localize('Impressive organisational, administrative, and accounting skills'),
            localize('Excellent oral and written communication skills in English\n'),
        ],
    },
    {
        title: localize('HR Operations Executive'),
        ...
        responsibilities: [
            ...
            localize('Input accounting entries into Xero.com.'),
            localize('Manage office expenses and petty cash.'),
            localize('Coordinate with our head office on all finance-related matters.'),
        ],
        qualifications: [
            localize('Advanced/higher/graduate diploma or university degree'),
            localize(
            ...
            localize('Sharp administrative and accounting skills'),
            localize('Excellent oral and written communication skills in English and Spanish\n'),
        ],
        preferences: [localize('Relevant work experience in a related field')],
    },
    {
        ...
        responsibilities: [
            ...
            localize('Find and recruit candidates using various online and offline channels.'),
            localize(
            ...
            localize('Schedule and coordinate interview with candidates.'),
            localize(
        ...
        qualifications: [
            localize('A university degree or other relevant professional qualifications'),
            localize('Excellent proficiency in oral and written English with interpersonal skills'),
            localize(
            ...
            localize('Strong decision-making skills and the ability to work independently'),
            localize('Proficiency of office software such as Word, Excel, etc.'),
            localize('Ability to quickly learn new systems and procedures'),
        ],
        preferences: [
            localize('Experience as a recruiter in the financial or IT industries'),
            localize('Knowledge of applicable employment laws and regulations\n'),
        ],
    },
    {
        title: localize('Office Coordinator'),
