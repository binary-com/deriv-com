...
export const marketing_positions = [
    {
        ...
        team: 'marketing',
        description: [localize('You will drive growth and business development in Thailand.')],
        responsibilities: [
            localize('Grow our affiliate networks in Thailand.'),
            localize(
    ...
    },
    {
        ...
        type: [job_types.full_time],
        team: 'marketing',
        description: [localize('You will drive growth and business development in Vietnam.')],
        responsibilities: [
            localize('Grow our affiliate networks in Vietnam.'),
            localize(
                'Perform market research and data analysis to uncover trends, prospects, and\ncompetitors that lead to new growth opportunities.',
            ),
            localize(
    ...
    },
    {
        ...
        responsibilities: [
            ...
            localize('Keep up-to-date with the latest PPC-related developments'),
        ],
        qualifications: [
            localize(
        ...
        preferences: [
            localize('Certificate in Google Ads, YouTube Advertising, or Google Analytics'),
            localize('Background in an international work environment\n'),
        ],
    },
    {
        ...
        qualifications: [
            ...
            localize('Good balance of creativity and analytical skills'),
            localize(
    ...
    },
    {
        ...
        responsibilities: [
            ...
            localize('Oversee the day-to-day operations of the team. '),
            localize(
    ...
    },
    {
        ...
        responsibilities: [
            localize('Develop in-depth knowledge of our target audience and company values.'),
            localize('Assist in developing and managing digital marketing campaigns.'),
            localize('Write marketing content drafts for a variety of channels.  '),
            localize('Work with our copywriters and designers to optimise marketing content. '),
            localize(
                'Conceptualise, edit, and publish digital content such as videos, infographics, and posts.',
            ),
            localize('Work on printed materials to supplement online products. '),
            localize(
                'Work with the Business Intelligence team to track and analyse website traffic flow and provide regular internal reports. ',
            ),
            localize('Organise webinars and webcasts. '),
            localize(
                'Identify new trends in digital marketing, evaluate new technologies, and ensure that our brand is at the forefront of industry developments in mobile marketing. ',
            ),
        ],
        qualifications: [
            ...
            localize('Strong analytical and communication skills'),
            localize(
    ...
    },
    {
        ...
        qualifications: [
            ...
            localize('Passion for meeting new people'),
            localize('Friendly and approachable personality'),
            localize('Ability to think critically and exercise good judgment in any situation'),
        ],
        preferences: [
            localize('Proficiency in an additional language'),
            localize('Experience in the financial services industry\n'),
        ],
    },
    {
        ...
        responsibilities: [
            ...
            localize('Make data-driven recommendations to increase affiliate performance. '),
            localize(
    ...
    },
    {
        ...
        responsibilities: [
            ...
            localize('Monitor and report on the progress and effectiveness of our SEM campaigns.'),
            localize('Ensure our campaigns stay within budget.'),
        ...
        preferences: [
            ...
            localize('Experience in gaming or financial markets\n'),
        ],
    },
    {
        ...
        responsibilities: [
            ...
            localize('Monitor and report on the progress and effectiveness of our SMM campaigns.'),
            localize('Work closely with other teams to support the enhancement of online assets.'),
            localize('Drive continued innovation and best practice implementation.'),
            localize('Research and analyse SMM campaigns by our competitors.'),
        ],
        qualifications: [
            ...
            localize('Ability to generate hypotheses and perform A/B testing'),
            localize('Ability to collect and analyse statistics'),
    ...
    },
    {
        ...
        qualifications: [
            ...
            localize('Strong oral and written communication skills in English and Russian'),
            localize('Knowledge and experience in the financial services industry'),
            localize('A passion for finance and technology'),
        ],
    },
    ...
    },
    {
        ...
        responsibilities: [
            localize('Grow our affiliate networks across South America.'),
            localize(
        ...
        preferences: [
            localize('Proficiency in Portuguese'),
            localize('Experience in the financial services industry\n'),
        ],
    },
    {
    ...
    },
    {
        ...
        type: [job_types.full_time],
        team: 'marketing',
        description: [localize('You will create and execute online PPC campaigns.')],
        responsibilities: [
            localize(
        ...
        qualifications: [
            ...
            localize('Knowledge of affiliate marketing and email marketing'),
        ],
        preferences: [
            localize('Experience in the financial services industry'),
            localize('Experience in content writing'),
        ],
    },
    {
        ...
        description: [
            localize(
                'You will be involved in the planning, execution, and optimisation of our online marketing efforts. You will promote our products and services through digital channels and leveraging data.\n',
            ),
        ],
        responsibilities: [
            localize('Assist in developing and managing digital marketing campaigns.'),
            localize(
                'Work with our copywriters and designers to optimise content for websites and social media channels. ',
            ),
            localize(
                'Track and analyse website traffic flow and provide regular internal reports. ',
            ),
            localize('Fix any errors and bugs in online content. '),
            localize('Edit and post videos and other types of digital content. '),
            localize('Arrange webinars and webcasts. '),
            localize('Write a draft copy for email marketing campaigns. '),
            localize(
                'Identify new trends in digital marketing, evaluate new technologies, and ensure that our brand is at the forefront of industry developments in mobile marketing. ',
            ),
            localize('Work on printed materials to supplement online products. '),
