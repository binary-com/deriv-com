...
export const business_intelligence_positions = [
    {
        ...
        qualifications: [
            ...
            localize('Strong communication skills'),
            localize(
                'Ability to present data using various tools to help the team to make informed business decisions\n',
            ),
        ],
        preferences: [
            localize('Experience with cybersecurity and data protection'),
            localize('Experience with MDX query language'),
            localize('Experience with AWS Cloud'),
            localize('Experience with Google Cloud (BigQuery)'),
        ],
    },
    {
        ...
        qualifications: [
            ...
            localize('Forest, Boosting, text mining, social media analysis, etc.'),
            localize(
                'Strong analytical skills with the ability to transform data into optimal business decisions',
            ),
            localize('A strong background in statistics, mathematics or engineering'),
            localize('Strong communication skills'),
            localize(
                'Ability to present data using various tools to help the team to make informed business decisions',
            ),
        ...
        preferences: [
            localize('Experience in data visualisation'),
            localize('Experience in cybersecurity and data protection'),
            localize('Experience with MDX query language'),
        ],
    },
]
