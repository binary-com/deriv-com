export default {
    ...
    subtitle:
        'Besqaure is built on the idea that successful professionals are generalists. Here’s an outline of your BeSquare journey that will carry on far beyond the 6 months of the programme:',
    content: [
