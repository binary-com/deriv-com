...
export default {
    ...
    subtitle: "Over the course of 5 months, you'll go through 5 modules and face exciting challenges",
    content: [
        {
            src: FrontEnd,
        ...
        },
        {
            ...
            content: [
                ...
                'Sketch and prototype the solutions you’ve defined in Stage 2.',
