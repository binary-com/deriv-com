...
export const cyberjaya = {
    ...
    thumbnail: 'thumbnail_cyberjaya.png',
    header_p: localize(
...
export const malta = {
    ...
    first_img: 'living_in_malta.png',
    grid_images: ['malta_grid_1.png', 'malta_grid_2.png', 'malta_grid_3.png', 'malta_grid_4.png'],
    map: 'map_malta.png',
    map_text:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure.',
...
export const dubai = {
    ...
    first_img: 'living_in_dubai.png',
    grid_images: ['dubai_grid_1.png', 'dubai_grid_2.png', 'dubai_grid_3.png', 'dubai_grid_4.png'],
    map: 'map_dubai.png',
    map_text:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure.',
...
export const labuan = {
    ...
    country: localize('Malaysia'),
    hero_img: 'labuan.png',
    thumbnail: 'thumbnail_labuan.png',
    header_p: localize(
...
export const asuncion = {
    ...
    thumbnail: 'thumbnail_asuncion.png',
    header_p: localize(
