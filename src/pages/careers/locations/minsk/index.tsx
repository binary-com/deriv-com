...
const query = graphql`
    query {
        ...
        minsk_grid_1: file(relativePath: { eq: "careers/minsk_grid_1.png" }) {
            childImageSharp {
                gatsbyImageData(formats: [AUTO, WEBP], layout: CONSTRAINED, quality: 70, placeholder: NONE)
            }
        }
        ...
        minsk_great_place_to_work_badge: file(relativePath: { eq: "careers/minsk_great_place_to_work_badge.png" }) {
            ...fadeIn
        }
    }
`;
