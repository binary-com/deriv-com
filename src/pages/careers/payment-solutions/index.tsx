...
const Career2 = () => {
    return (
        <>
            <SEO
                title="_t_Deriv Careers | Payment solutions and integration jobs_t_"
                description="_t_See job vacancies in Deriv’s Payment solutions and integration team. Join and grow with us._t_"
            />
