...
const Career2 = () => {
    return (
        <>
            <SEO
                title="_t_Deriv Careers | Software testing - Quality assurance jobs_t_"
                description="_t_See job vacancies in Deriv’s Software testing - Quality assurance team. Join and grow with us._t_"
            />
