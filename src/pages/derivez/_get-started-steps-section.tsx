...
const demo_step1_alt = 'Deriv GO trading app'
const real_step1_alt = 'Deriv GO trading app'
const demo_step2_title: TString =
    '_t_Sign in to your Deriv account. If you don’t have one, sign up for free._t_'
const demo_step2_alt = 'Deriv GO app create free demo account'
const real_step2_alt = 'Deriv GO app create free demo account'
const demo_step3_title: TString = '_t_Add a Deriv EZ demo account._t_'
const demo_step3_alt = 'Deriv EZ demo account for trading'
const demo_step4_title: TString = '_t_Start trading on the Deriv GO mobile app._t_'
const real_demo_step4_alt = 'Candle chart trading'
...
const real_step3_alt = 'Currencies to trade in Deriv GO'
const real_step4_title: TString = '_t_Create a Deriv EZ real account._t_'
const real_step4_alt = 'CFD trading with Deriv EZ'
const real_step5_title: TString = '_t_Fund your account._t_'
const real_step5_alt = 'Transfer between your accounts’'
