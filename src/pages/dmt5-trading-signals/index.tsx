...
const signal_content_subscriber = {
    ...
    list: [
        <Localize translate_text="_t_Minimise trading risk by copying from expert traders._t_" key={0} />,
        <Localize
        ...
        <Localize translate_text="_t_Full disclosure of each providers’ performances._t_" key={3} />,
...
const signal_content_provider = {
    ...
    list: [
        ...
        <Localize translate_text="_t_Additional income stream from monthly subscriptions._t_" key={1} />,
            ...
            <Hero jc="cneter" ai="center">
                <SmallContainer>
                    <Header as="h1" type="display-title" color="white" align="center">
                        {localize('_t_Deriv MT5 signals_t_')}
                    </Header>
                </SmallContainer>
            </Hero>
            <TabsContainer>
                {is_mounted && (
                    ...
                    >
                        <Header as="h4">{localize('_t_Signal subscriber_t_')}</Header>
                    </Item>
                )}
                {is_mounted && (
                    <Item
                    ...
                    >
                        <Header as="h4">{localize('_t_Signal provider_t_')}</Header>
                    </Item>
                )}
            </TabsContainer>
