...
export const StartTrader = Loadable(() => import('./_start-trader'))
export const SwapFreeTrading = Loadable(() => import('./_interest_free_trading'))
export const WhyTrader = Loadable(() => import('./_why-trade-dmt5'))
