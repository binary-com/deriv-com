    ...
    mainEntity: [
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize("DMT5 is the MT5 platform on Deriv. It is a multi-asset online platform designed to give new and experienced traders access to a wide range of financial markets."),
            },
        },
        {
            '@type': 'Question',
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize("DBot is a web-based strategy builder for trading digital options. It’s a platform where you can build your own trading bot using drag-and-drop 'blocks'."),
            },
        },
        {
            '@type': 'Question',
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text:
                    localize("Deriv X is an easy to-use trading platform where you can trade CFDs on various assets on a platform layout that you can customise according to your preference."),
            },
        },
        {
            '@type': 'Question',
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize("You can trade forex, stock indices, commodities, and synthetic indices on DTrader."),
            },
        },
    ],
}
