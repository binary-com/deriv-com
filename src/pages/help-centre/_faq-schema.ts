...
export const faq_schema: FaqSchemaType = {
    ...
    mainEntity: [
        {
            '@type': 'Question',
            name: localize('_t_What is DMT5?_t_'),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    '_t_DMT5 is the MT5 platform on Deriv. It is a multi-asset online platform designed to give new and experienced traders access to a wide range of financial markets._t_',
                ),
            },
        },
        {
        ...
        {
            '@type': 'Question',
            name: localize('_t_What are the major differences between DTrader and DMT5?_t_'),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
            ...
            acceptedAnswerEU: {
                '@type': 'Answer',
                text: localize(
                    '_t_DTrader allows you to trade more than 50 assets in the form of digitals, multiplier, and lookback options.<br />DMT5 is a multi-asset trading platform that you can use to trade spot forex and contracts for difference (CFDs) with leverage._t_',
                ),
            },
        },
        {
            '@type': 'Question',
            name: localize(
                '_t_What are the differences between the DMT5 Standard, Advanced, and Synthetic Indices accounts?_t_',
            ),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
                    '_t_The DMT5 Standard account offers new and experienced traders high leverage and variable spreads for maximum flexibility._t_',
                ),
            },
            acceptedAnswerEU: {
                '@type': 'Answer',
