...
// import { PropsType } from './_article-component'
...
// const HelpCentre = ({ props }: HelpCenterProps) => {
...
//     const [clearSearch, setSearch] = useState('')
...
//     const [answers, setArticles] = useState({ all_categories, all_articles })
//     setArticles({
//         all_categories,
...
//     const splitted_articles = props.is_eu_country
...
//         <SearchCrossIcon src={CrossIcon} alt="cross icon" onClick={() => setSearch(clearSearch)} />
//     )
...
//             </Helmet>
//             <SearchSection
//                 show={searching.toggle_search}
//                 has_transition={searching.search_has_transition}
//             >
//                 <Backdrop>
...
//                                     onChange={(text) => {
//                                         text.preventDefault()
//                                         setInputChange(text.target.value)
//                                     }}
...
//                                             id={id}
//                                             item={item}
//                                             all_categories={answers}
//                                             is_eu_country={props.is_eu_country}
