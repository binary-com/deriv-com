...
const WhyAffiliate = ({ text }: ArticleProps) => (
    <ArticleWrapper>
        <StyledHeader as="h4">{text}</StyledHeader>
        <Text>{<Localize translate_text="When you join our affiliate programme," />}</Text>
...
const CommissionPlans = ({ text }: ArticleProps) => (
    <ArticleWrapper>
        <StyledHeader as="h4">{text}</StyledHeader>
        <Text>{<Localize translate_text="We have 3 commission plans:" />}</Text>

        <Text>
            <Localize
                padding="5"
                translate_text="<0>Revenue share</0><br/>
        ...
        <Text>
            <Localize
                translate_text="<0>Turnover</0><br/>
    ...
    <ArticleWrapper>
        ...
        <StyledList listStyle="disc" paddingLeft="5rem">
            <StyledListItem marginTop="1rem">
                <Text>
                    <Localize
                        translate_text="<0>A webmaster</0><br/>
            ...
            <StyledListItem marginTop="1rem">
                <Text>
                    <Localize
                        translate_text="<0>A signal provider</0><br/>
            ...
            <StyledListItem marginTop="1rem">
                <Text>
                    <Localize
                        translate_text="<0>A trading mentor</0><br/>
            ...
            <StyledListItem marginTop="1rem">
                <Text>
                    <Localize
                        translate_text="<0>A social media admin</0><br/>
            ...
            <StyledListItem marginTop="1rem">
                <Text>
                    <Localize
                        translate_text="<0>A blogger/vlogger</0><br/>
...
const ReferralLink = ({ text }: ArticleProps) => (
    <ArticleWrapper>
        <StyledHeader as="h4">{text}</StyledHeader>
        <Text>{<Localize translate_text="Follow these steps to get your referral link:" />}</Text>
...
const SeeEarnings = ({ text }: ArticleProps) => (
    <ArticleWrapper>
        <StyledHeader as="h4">{text}</StyledHeader>
        <Text>{<Localize translate_text="Follow these steps to see your earnings:" />}</Text>
        <StyledList listStyle="decimal" paddingLeft="5rem">
            <StyledListItem marginTop="1rem">
                <Text>
                    <Localize
