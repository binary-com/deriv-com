...
import ChatIcon from 'images/svg/help-center/help_center_chat_icon.svg'
import ComplianceIcon from 'images/svg/help-center/help_center_compliance_icon.svg'
