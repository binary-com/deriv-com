...
const accumulators: TQuestionsData = {
    section: 'General',
    category: localize('_t_Accumulators_t_'),
    hide_for_eu: true,
    questions: [
        {
            question: localize('_t_What are accumulators?_t_'),
            category: 'accumulators',
            hide_for_eu: true,
            sub_category: localize('_t_Accumulators_t_'),
            label: 'what-are-accumulators',
            answer: [
                {
                    translation_text: localize(
                ...
                {
                    translation_text: localize(
                        '_t_To find out more, visit the <0>Accumulators page</0>._t_',
                    ),
        ...
        {
            question: localize('_t_How do I trade accumulators?_t_'),
            category: 'accumulators',
            hide_for_eu: true,
            sub_category: localize('_t_Accumulators_t_'),
        ...
        {
            question: localize('_t_How are accumulators different from multipliers?_t_'),
            category: 'accumulators',
            hide_for_eu: true,
            sub_category: localize('_t_Accumulators_t_'),
        ...
        {
            question: localize('_t_Do accumulators have any trade protection features?_t_'),
            category: 'accumulators',
            hide_for_eu: true,
            sub_category: localize('_t_Accumulators_t_'),
        ...
        {
            question: localize('_t_When can I close an accumulator trade?_t_'),
            category: 'accumulators',
            sub_category: localize('_t_Accumulators_t_'),
            hide_for_eu: true,
