...
const complaints_procedure: TQuestionsData = {
    ...
    questions: [
                ...
                },
                {
                    ...
                    list: {
                        ...
                        items: [{
                            ...
                            translation_components: [{ key: 0, type: 'link', to: '/contact_us/?is_livechat' }],
                        }, {
                            translation_text:
                ...
                },
                {
                    ...
                    list: {
                        ...
                        items: [{
                            ...
                            translation_text:
                                '_t_Click the widget to open the chat window._t_',
                        },
                        {
                            translation_text:
        ...
        {
            question: '_t_What should I do if I\'m not happy with the response from your customer support team?_t_',
            category: 'Complaints procedure',
            sub_category: '_t_Complaints_t_',
            ...
            answer: [
                {
                    ...
                    translation_components: [{ key: 0, type: 'strong' }, { key: 1, type: 'deriv_app_link', to: '/complaints-policy' }],
                },
            ],
        },
        {
            ...
            answer: [
                {
                    ...
                    translation_components: [{ key: 0, type: 'deriv_app_link', to: '/complaints-policy' }],
                },
            ],
        },
        {
