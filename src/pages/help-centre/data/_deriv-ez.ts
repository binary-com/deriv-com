            ...
            answer: [
                ...
                },
                {
                    list: {
                        ...
                        items: [
                            {
                                translation_text: '_t_Log in to your Deriv account on the Deriv GO mobile app._t_',
                            },
                            {
                            ...
                            {
                                translation_text: '_t_Hit <0>Get</0> under <1>CFDs</1> and <2>Deriv EZ</2>._t_',
                                translation_components: [
                                    { key: 0, type: 'strong' },
                                    { key: 1, type: 'strong' },
                                    { key: 2, type: 'strong' },
            ...
            answer: [
                {
                    ...
                    translation_components: [{ key: 0, type: 'link', to: '/trader-tools/margin-calculator/' }],
                },
            ],
        },
        {
