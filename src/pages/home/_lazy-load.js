...
export const Trade = Loadable(() => import('./_trade'))
export const TradeTheWayYouLike = Loadable(() => import('./_trade-the-way-you-like'))
export const Markets = Loadable(() => import('./_markets'))
export const TradeTypes = Loadable(() => import('./_trade-types'))
export const TradeTypesMobile = Loadable(() => import('./_trade-types-mobile'))
