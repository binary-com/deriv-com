...
import CFDsLogo from 'images/svg/trade-types/margin.svg'
...
const TradeTypes = () => {
    ...
    const cfd = {
        icon: <img src={CFDsLogo} alt="CFDs" width="48" height="49" />,
    ...
    const trade_types = is_eu_country ? [cfd, multipliers] : [cfd, options, multipliers]
