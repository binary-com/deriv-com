export const translation_strings = [
    ...
    '_t_Top trading assets & unique market indices_t_',
    ...
    '_t_See all derived indices pairs_t_',
    '_t_You call the stocks_t_',
    '_t_Take a position on 1500+ stocks and indices._t_',
    '_t_See all ETFs pairs_t_',
    '_t_Mine for commodities._t_',
    '_t_Trade the price of precious metals and oil._t_',
    '_t_See all stocks & indices pairs_t_',
