...
export const platform_details_cr: TPlatformDetails[] = [
    ...
    },
    {
        ...
        download_links: [
            { type: 'mac_app_store', url: dmt5_mac_app_url, should_hide_in_mobile: true },
            { type: 'windows', url: dmt5_windows_download_url, should_hide_in_mobile: true },
            { type: 'linux', url: dmt5_linux_url, should_hide_in_mobile: true },
