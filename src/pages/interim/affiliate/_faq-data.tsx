...
const WhyRebrand = () => (
    <MaxWidth>
        <Text>
            {localize(
                '_t_After 20 years in the market, we feel that it’s time to renew our commitment to clients. The rebranding strengthens our resolve to serve clients with simple, flexible, and reliable online trading solutions._t_',
            )}
        </Text>
    </MaxWidth>
)
...
const WhySwitch = () => (
    <MaxWidth>
        <Text>
            {localize(
                '_t_The rebranding exercise was inspired by you, our clients. After 20 years of service to you, we feel that we understand you better. The rebranding is an opportunity for us to implement an improved online trading solution to meet all your needs._t_',
            )}
        </Text>
    </MaxWidth>
)
    ...
    <MaxWidth>
        ...
        <StyledUl>
            <li>
                <Text>
                    {localize(
                        '_t_Multiplier options that potentially offer traders higher profits while limiting risks_t_',
                    )}
                </Text>
            </li>
            <li>
                <Text>
                    {localize('_t_P2P Cashier which facilitates seamless financial transactions_t_')}
                </Text>
            </li>
            <li>
                <Text>
                    {localize('_t_Light and dark mode features for a more enjoyable experience_t_')}
                </Text>
            </li>
        </StyledUl>
    </MaxWidth>
...
const DifferentiateCommission = () => (
    <MaxWidth>
        <Text mb="2.4rem">{localize('_t_We have separated the reports for your convenience._t_')}</Text>
