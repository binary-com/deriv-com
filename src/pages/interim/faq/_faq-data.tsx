...
const WhatToExpect = () => (
    <MaxWidth>
        <Text mb="0.8rem">
            {localize(
                '_t_As we roll out new features in phases, you can look forward to such things as:_t_',
            )}
        </Text>
        <StyledUl>
            <li>
                <Text>
                    {localize(
                        '_t_Multipliers that potentially offer traders higher profits while limiting risks_t_',
                    )}
                </Text>
            </li>
            <li>
