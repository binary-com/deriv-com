...
const topics_covered = [
    localize('_t_Introduction to cryptocurrencies_t_'),
    localize('_t_Types of cryptocurrencies_t_'),
    localize('_t_The basics of trading cryptocurrency_t_'),
    localize('_t_Order types for derivatives trading_t_'),
    localize('_t_How to evaluate a cryptocurrency_t_'),
    localize('_t_Common crypto terms to impress your friends_t_'),
]
    ...
    return (
        <Layout type="landing-page" is_ppc_redirect={true}>
            ...
            <Hero
                ...
                introSub=""
                introMain={localize('_t_Learn how to trade cryptocurrencies with Deriv_t_')}
            ...
            <ImageText
                ...
                introPara={localize(
                    '_t_Trading cryptocurrencies gives you the chance to earn profits from price movements without owning the underlying digital coins. In other words, you can earn by correctly predicting whether the price of a cryptocurrency will go up or down._t_',
                )}
                subPara={localize(
            ...
            />
            <Topics
                title={localize('_t_In this e-book we will cover_t_')}
