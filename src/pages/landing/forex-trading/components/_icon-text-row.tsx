...
import Arrow from 'images/svg/landing/landing_arrow.svg'
import RightAd from 'images/svg/landing/landing_percent.svg'
import SettlePayment from 'images/svg/landing/landing_zero.svg'
import CompleteOrder from 'images/svg/landing/landing_doller.svg'
        ...
        <Section background="var(--color-grey-30)">
            ...
            <CardContainer pr="4.7rem" pl="6.7rem">
                <Card direction="column">
                    <Row>
                        <img src={Arrow} alt={localize('_t_arrow_t_')} width="96.5px" />
                    </Row>
                    <Row>
                        <Column>
                            <StyledCardHeader
                                ...
                                color="black-3"
                            >
                                <Localize translate_text="_t_Low spreads_t_" />
                            </StyledCardHeader>
                            <StyledText
                                size="24px"
                                color="black-3"
                                ...
                                weight="350"
                            >
                                <Localize translate_text="_t_Open trades at a lower cost and increase your potential gains._t_" />
                            </StyledText>
                        </Column>
                    </Row>
                </Card>
                <Card direction="column">
                    <Row>
                        <img src={RightAd} alt={localize('_t_high leverage_t_')} width="98px" />
                    </Row>
                    <Row>
                        <Column>
                            <StyledCardHeader
                ...
                <Card direction="column">
                    <Row>
                        <img src={CompleteOrder} alt={localize('_t_swap free_t_')} width="108px" />
                    </Row>
                    <Row>
                        <Column>
                            <StyledCardHeader
