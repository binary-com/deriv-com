...
const MarketStockIcon = ({ dynamic_id }) => (
    <svg
        role="img"
        aria-labelledby="market-stock-indices"
    ...
    >
        ...
        <defs>
            <linearGradient id={dynamic_id} x1="0%" x2="100%" y1="85.596%" y2="14.404%">
