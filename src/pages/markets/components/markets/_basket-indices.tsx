...
const BasketIndices = ({ simple_step_content }: BasketIndicesProps) => {
    ...
    return (
        <>
            <ROW>
                <WhyTrade
                    header={<Localize translate_text="_t_Why trade basket indices on Deriv_t_" />}
                    text={
                ...
                <SimpleSteps
                    header={
                        <Localize translate_text="_t_Start trading basket indices on Deriv in 3 simple steps_t_" />
                    }
