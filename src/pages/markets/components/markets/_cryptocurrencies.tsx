        ...
        <>
            <WhyTrade header={<Localize translate_text='Why trade cryptocurrencies on Deriv' />}>
                {crypto_content.map((content, index) => (
                    <StyledBox key={index} text={content.text} icon={<img src={content.src} alt={content.alt} />} />
                ))}
            </WhyTrade>
            <AvailableTrades
            ...
            />
            <SimpleSteps
                header={<Localize translate_text='Start trading cryptocurrencies on Deriv in 3 simple steps' />}
