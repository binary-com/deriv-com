            ...
            <ContentWrapper>
                <Descriptions>
                    <StyledText font_size="16px" align="center">
                        <Localize translate_text="_t_Options trading allows for fixed payouts from correctly predicting market movements, without needing to buy an underlying asset._t_" />
                    </StyledText>
                    {what_to_show ? (
                ...
                <Header as="h3" type="paragraph-1" weight="bold" mt="4.0rem">
                    {localize('_t_Instruments available for options trading_t_')}
                </Header>
