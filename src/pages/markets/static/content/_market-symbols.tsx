...
export const volatility_indices: MarketSymbol[] = [
    ...
    {
        src: 'VINDEX1501S',
        text: <Localize translate_text="_t_Volatility 150 (1s) Index_t_" />,
    },
    {
        src: 'VINDEX2501S',
        text: <Localize translate_text="_t_Volatility 250 (1s) Index_t_" />,
    },
    {
        src: 'INDEX10NEW',
        text: <Localize translate_text="_t_Volatility 10 Index_t_" />,
...
export const dex_indices = [
    {
        src: 'DEX900UP',
        text: <Localize translate_text="_t__t_DEX 900UP_t__t_" />,
    },
    {
        src: 'DEX900DN',
        text: <Localize translate_text="_t__t_DEX 900DN_t__t_" />,
    },
]
