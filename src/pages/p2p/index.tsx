...
const DP2P_CONTENT: P2PType[] = [
    {
        ...
        subtitle_mobile_component: [<br key={0} />],
        image_name: 'buy_sell',
        image_alt: '_t_Deriv’s P2P app buy and sell_t_',
    },
    {
        ...
        image_alt: '_t_Deriv’s P2P app sending and receiving money_t_',
    },
    {
        ...
        image_alt: '_t_“Deriv’s P2P web and mobile app_t_',
    },
]
