                        ...
                        <Card>
                            <div>
                                ...
                                <RevenueShare>
                                    <Text>
                                        <Localize
                                            translate_text="You earn <0>30% commission</0> on total net revenue of <0>USD 20,000</0> per month or less."
                                            components={[<strong key={0} />]} />
                                    </Text>
                                    <Text>
                                        <Localize
                                            translate_text="You earn <0>45% commission</0> on total net revenue of more than <0>USD 20,000</0> per month."
                                            components={[<strong key={0} />]} />
                                    </Text>
                                </RevenueShare>
                            </div>
