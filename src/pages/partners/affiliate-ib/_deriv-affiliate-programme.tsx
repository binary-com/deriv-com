    ...
    return (
        <StyledSection>
            <ContentContainer direction="column">
                <TitleWrapper>
                    <Header type="heading-2" align="center" as="h3" mb="1.2rem">
                        {localize('Deriv Affiliate Programme')}
                    </Header>
                    <SubtitleHeader as="h4" type="subtitle-1" align="center" weight="normal">
                        {localize(
                ...
                <ComissionPlanContainer>
                    ...
                    <CardWrapper>
                        <StyledCard height="57.0rem" tabletHeight="auto" padding="2.4rem">
                            <div>
                                <Header as="h4" type="subtitle-1" mb="0.8rem">
                                    {localize('Revenue share')}
                                </Header>
                                <Header as="h2" type="paragraph-1" weight="regular">
                                    {localize(
                        ...
                        <StyledCard height="57.0rem" tabletHeight="auto" padding="2.4rem">
                            <div>
                                ...
                                <Header as="h2" type="paragraph-1" weight="regular" mt="2.4rem">
                                    <Localize
                        ...
                        <StyledCard height="57.0rem" tabletHeight="auto" padding="2.4rem">
                            <div>
                                ...
                                <Header as="h2" type="paragraph-1" weight="regular" pb="16px">
