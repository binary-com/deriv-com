...
const ib_dmt5_synthetic: DMT5Type = {
    ...
    description: <Localize translate_text='Earn when your clients trade on an MT5 Derived account.' />,
    type: [
        {
...
const ib_dmt5_financial: DMT5Type = {
    ...
    description: <Localize translate_text='Earn when your clients trade on an MT5 Financial account.' />,
    type: [
        {
            ...
            assets: [
                {
                    title: <Localize key={0} translate_text='Asset' />,
                    list: [<Localize key={1} translate_text='Forex' />, <Localize key={2} translate_text='Metals' />],
                },
                {
                    title: <Localize key={0} translate_text='Commission per lot' />,
                    list: [<Localize key={1} translate_text='USD 2' />, <Localize key={2} translate_text='USD 4' />],
                },
            ],
        ...
        },
        {
            ...
            assets: [
                ...
                {
                    title: <Localize key={0} translate_text='Commission per USD 100k turnover' />,
                    list: [<Localize key={1} translate_text='USD 1' />, <Localize key={2} translate_text='USD 10' />],
                },
            ],
...
const ib_dmt5_financialSTP: DMT5Type = {
    ...
    description: <Localize translate_text='Earn when your clients trade on an MT5 Financial STP account.' />,
    type: [
        {
            ...
            assets: [
                ...
                {
                    title: <Localize key={0} translate_text='Commission per lot (1 standard lot is 100k units)' />,
