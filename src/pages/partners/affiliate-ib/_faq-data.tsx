    ...
    return (
        <ItemContainer>
            ...
            <StyledUl>
                ...
                <li>
                    <TextList>
                        <Localize translate_text="_t_A software developer with your own trading platform that can be linked to Deriv’s API. Head to the Deriv API page for more info on how our API works._t_" />
                    </TextList>
                </li>
            </StyledUl>
            <Header as="p" type="paragraph-1" mt="16px">
...
const AffiliateAccountManagement = () => (
    <ItemContainer>
        ...
        <Header as="p" type="paragraph-1" mt="8px" weight="normal">
            <Localize translate_text="_t_If you are still having issues, please contact our support team _t_" />
...
const AffiliateReferralTools = () => (
    <ItemContainer>
        ...
        <Header as="p" type="paragraph-1" mt="8px" weight="normal">
            <Localize translate_text="_t_If you like certain tools to be customised to your site requirements, please contact our support team via live chat or reach out to your account manager._t_" />
        </Header>
        <Header as="p" type="paragraph-1" mt="16px">
