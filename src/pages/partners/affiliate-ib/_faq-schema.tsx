...
export const faq_schema: FaqSchemaType = {
    ...
    mainEntity: [
        ...
        {
            '@type': 'Question',
            name: localize('_t_How much can I earn from referring new clients to your DMT5 platform?_t_'),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize('_t_There is absolutely no requirement to withdraw your IB commissions._t_'),
            },
        },
        {
            '@type': 'Question',
