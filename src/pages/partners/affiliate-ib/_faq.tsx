...
const Faq = () => {
    return (
        <RelativeContainer>
            ...
            <FaqSubHeader as='h3' type='sub-section-title' align='center' m='4rem 0' weight='normal'>
            ...
            <FaqSubHeader as='h3' type='sub-section-title' align='center' m='8rem 0 4rem 0 ' weight='normal'>
