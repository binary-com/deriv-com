            ...
            <div>
                ...
                <CPAContent>
                    <Header as="p" type="paragraph-1" weight="normal">
                        <Localize
                            translate_text="_t_You earn <0>100 USD</0> when your new referred client deposits a total amount of <0>100 USD</0> or its equivalent into their Deriv account, either in one deposit or cumulatively._t_"
