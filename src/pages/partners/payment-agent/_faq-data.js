...
const General = (
    <ItemContainer>
        ...
        <HeaderPrimary>{localize('Why do clients need a payment agent? ')}</HeaderPrimary>
        <TextPrimary>
            {localize(
        ...
        <HeaderPrimary>{localize('Who sets the commission rate per transaction?')}</HeaderPrimary>
        <TextPrimary>
            {localize(
...
const AccountManagement = (
    <ItemContainer>
        ...
        <HeaderPrimary>{localize('Can I advertise my services to Deriv clients?')}</HeaderPrimary>
        <TextPrimary>
            <TextPrimary>
                <Localize
