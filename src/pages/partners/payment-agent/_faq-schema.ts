...
export const faq_schema: FaqSchemaType = {
    ...
    mainEntity: [
        ...
        {
            '@type': 'Question',
            name: localize('_t_Is the Deriv Payment Agent Programme the same as Deriv P2P (DP2P)?_t_'),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
        ...
        {
            '@type': 'Question',
            name: localize('_t_Are there any fees I need to pay to become a payment agent on Deriv?_t_'),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize('_t_Not at all. Joining our payment agent programme is completely free._t_'),
            },
        },
        {
            '@type': 'Question',
        ...
        {
            '@type': 'Question',
            name: localize('_t_What happens if a payment agent charges more than the set commission threshold?_t_'),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize('_t_To change your payment method, please contact us via livechat._t_'),
            },
        },
        {
            '@type': 'Question',
        ...
        {
            '@type': 'Question',
            name: localize('_t_Will I still be able to trade with my account after registering as a payment agent?_t_'),
            acceptedAnswer: {
                '@type': 'Answer',
                text: localize(
