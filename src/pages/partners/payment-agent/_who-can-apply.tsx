...
import { useRegion } from 'themes/region.js'
                ...
                <Flex>
                    <WhoCanApplyWrapper>
                        ...
                        {section_content.map((item, index) => (
                            <SectionComponent img_src={item.img_src} header={item.header} text={item.text} key={`image-section-${index}`}
                                key={`key-${index}`}
