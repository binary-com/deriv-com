                ...
                <Flex>
                    <WhoCanApplyWrapper>
                        ...
                        <StyledUl>
                            <Li>
                                <Header as="h4" type="paragraph-1" weight="normal">
                                    <Localize translate_text="_t_You must maintain a minimum balance in your Deriv account while your application is under review. The specific amount depends on your country of residence, and you need to maintain this balance until your application is successful._t_" />
                                </Header>
                            </Li>
                            <Li>
                                <Header as="h4" type="paragraph-1" weight="normal">
                                    <Localize translate_text="_t_You can only provide services to Deriv clients in your country of residence._t_" />
                                </Header>
                            </Li>
                        </StyledUl>
                        <Header as="h4" type="paragraph-1" weight="normal">
