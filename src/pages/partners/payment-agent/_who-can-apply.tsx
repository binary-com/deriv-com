                ...
                <Flex>
                    <HowToApply>
                        ...
                        <Timeline pb='24px' pl='18px'>
                            <Timeline.Item>
                                <HowToApplyContent>
                                    <ImageWrapper src={Email} alt='Write us an email' left_margin='8px' />
                            ...
                            <Timeline.Item>
                                <HowToApplyContent>
                                    <ImageWrapper src={Reply} alt='Receive email response' left_margin='8px' />
                            ...
                            <Timeline.Item>
                                <HowToApplyContent>
                                    <ImageWrapper src={Listed} alt='Get the approval' left_margin='8px' />
                                    <Content max_width='38.2rem'>
                                        <Header as='h4' type='sub-section-title' pb='8px'>
