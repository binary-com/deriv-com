...
const WhoCanApply = () => {
    const { is_p2p_allowed_country } = useRegion({ should_verify_organization: true })
                ...
                <Flex>
                    <WhoCanApplyWrapper>
                        ...
                        <StyledUl>
                            <Li>
                                <Header as="h4" type="paragraph-1" weight="normal">
                                    <Localize translate_text="_t_You must have a minimum balance in your Deriv account while your application is under review. The amount of this balance depends on your country of residence. You only need to maintain the minimum balance until your application is successful. Please ensure that your organization is verified._t_" />
                                </Header>
                            </Li>
                            <Li>
                                <Header as="h4" type="paragraph-1" weight="normal">
                                    <Localize translate_text="_t_You can only service Deriv clients in your country of residence. Please ensure that your organization is verified._t_" />
                                </Header>
                            </Li>
                        </StyledUl>
                        <Header as="h4" type="paragraph-1" weight="normal">
