...
const Dp2p = () => {
    ...
    const dp2p_checklist: TDP2PCheckist[] = [
        ...
        },
        {
            ...
            subtitle: '_t_Traders are rated based on their completion rate and speed of exchanges._t_',
        },
        {
            ...
            <StyledContainer>
                    ...
                    {dp2p_checklist.map((item, index) => (
                        <div style={{ marginBottom: '1.6rem' }} key={index}>
                            <ItemTitle>
                                ...
                                <Text size={is_mobile ? 'var(--text-size-sm)' : 'var(--text-size-m)'} weight='bold'>
                ...
                <ContentRight>
                    <ImageWrapper ai='center'>
                        <QueryImage data={data.dp2p_platform} alt={localize('_t_DP2P Platform_t_')} width='100%' />
                    </ImageWrapper>
                    <ButtonWrapper>
