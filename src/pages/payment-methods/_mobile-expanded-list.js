    ...
    return (
        <Flex fd="column">
            ...
            {!is_fiat_onramp && (
                <>
                    <StyledRow jc="space-between" ai="center">
                        <StyledItemDiv>
                            {is_crypto ? (
                                <BoldText type="subtitle-2">{localize('Min withdrawal')}</BoldText>
                            ) : is_dp2p ? (
                                <BoldText type="subtitle-2">
            ...
            <StyledRow jc="space-between" ai="center">
                <StyledItemDiv>
                    {is_fiat_onramp ? (
                        <BoldText type="subtitle-2">{localize('Deposit processing time')}</BoldText>
                    ) : is_dp2p ? (
                        <BoldText type="subtitle-2">{localize('Daily withdrawal limits')}</BoldText>
                    ) : (
                        <BoldText type="subtitle-2">
                            <BoldText type="subtitle-2">{localize('Deposit')}</BoldText>
