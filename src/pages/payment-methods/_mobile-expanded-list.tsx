...
`;
const MobileExpandedList = ({ is_crypto, is_fiat_onramp, is_dp2p, locale, payment_data }: PaymentProps) => {
    ...
    return (
        <>
            <StyledItemWrapper jc='space-between' ai='center' onClick={toggleExpand} is_expanded={is_expanded}>
            ...
            <DetailsWrapper is_expanded={is_expanded}>
                <Flex fd='column'>
                    ...
                    <StyledRow jc='space-between' ai='center'>
                        ...
                        <StyledKeyDiv>
                            <ValueText is_rtl={is_rtl} type='subtitle-2' weight='normal'>
                                {payment_data?.deposit_time && <Localize translate_text={payment_data.deposit_time} />}
                            </ValueText>
                        </StyledKeyDiv>
                    </StyledRow>
                    ...
                    {(payment_data?.reference || payment_data?.reference_link) && (
                        <StyledRow jc='space-between' ai='center'>
                            <StyledItemDiv>
                                <Header as='p' type='subtitle-2'>
                                    <Localize translate_text={is_dp2p ? '_t_More info_t_' : '_t_Reference_t_'} />
                                </Header>
                            </StyledItemDiv>
                    ...
                    {payment_data.description && (
                        <Flex p='16px 0' fd='column'>
                            ...
                            {payment_data.url && (
                                <StyledButton onClick={() => window.open(payment_data.url, '_blank')} tertiary>
