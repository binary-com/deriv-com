...
const payment_data: PaymentDataProps[] = [
    {
        ...
        data: [
            ...
            },
            {
                ...
                description: '_t_Deposit and withdraw using your Mastercard credit or debit card._t_',
                name: 'mastercard',
        ...
        data: [
            {
                ...
                deposit_time: '_t_Instant_t_',
                withdrawal_time: '_t_1 working day_t_',
                description: '_t_Deposit and withdraw funds using your Visa credit or debit card._t_',
                name: 'visa',
            },
            {
                method: <StyledIcon src={VisaElectron} alt='Visa Electron' />,
    ...
    },
    {
        ...
        data: [
            ...
            },
            {
                ...
                description: '_t_Enjoy fast, smooth, and secure deposits and withdrawals with PayLivre._t_',
            ...
            },
            {
                ...
                description: '_t_Enjoy fast, smooth, and secure deposits and withdrawals with Trustly._t_',
            ...
            },
            {
                ...
                deposit_time: '_t_Instant_t_',
                withdrawal_time: '_t_1 - 2 working days_t_',
                description: '_t_Make deposits easily using your mobile. For clients in Uganda and Tanzania._t_',
            ...
            },
            {
                ...
                deposit_time: '_t_Instant_t_',
                withdrawal_time: '_t_Not applicable_t_',
                description: '_t_Make deposits easily with cash voucher payment solution for South Africa._t_',
                name: 'oneforyou',
            },
            {
                ...
                deposit_time: '_t_Instant_t_',
                withdrawal_time: '_t_Will be available soon_t_',
                description: '_t_Enjoy fast, smooth, and secure deposits and withdrawals with AdvCash._t_',
                name: 'advcash',
            },
        ],
    },
        ...
        data: [
            {
                ...
                withdrawal_time: '_t_1 working day_t_',
                description: '_t_Deposit and withdraw easily using secure and fast money transfers._t_',
            ...
            },
            {
                ...
                deposit_time: '_t_Instant_t_',
                withdrawal_time: '_t_Not applicable_t_',
                description: '_t_A leading payment service in Southeast Asia that’s fast, easy, and secure._t_',
                name: 'Help2Pay',
        ...
        data: [
            {
                ...
                deposit_time: '_t_Instant_t_',
                withdrawal_time: '_t_Not applicable_t_',
                description: '_t_Make deposits and withdrawals through your local bank in real-time._t_',
                name: 'Eps',
            },
            {
        ...
        data: [
            {
                ...
                description: '_t_Deposit and withdraw in Bitcoin, the world’s first cryptocurrency._t_',
                name: 'BTC',
            ...
            },
            {
                ...
                deposit_time: '_t_Funds available as soon as confirmed_t_',
                withdrawal_time: '_t_Subject to internal checks_t_',
                description: '_t_Deposit and withdraw in Ethereum, among the top 3 most used cryptocurrencies._t_',
                name: 'ETH',
            ...
            },
            {
                ...
                deposit_time: '_t_Funds available as soon as confirmed_t_',
                withdrawal_time: '_t_Subject to internal checks_t_',
                description: '_t_Deposit and withdraw in USD Coin, a cryptocurrency that’s pegged to USD._t_',
                name: 'USDC',
            },
            {
                ...
                deposit_time: '_t_Funds available as soon as confirmed_t_',
                withdrawal_time: '_t_Subject to internal checks_t_',
                description: '_t_Deposit and withdraw in Tether, a cryptocurrency that’s pegged to fiat currencies._t_',
                name: 'UST',
            },
        ],
