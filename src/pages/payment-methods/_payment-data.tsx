...
const payment_data = [
        ...
        data: [
            {
                ...
                description: <Localize translate_text='Deposit and withdraw using your Visa credit or debit card.' />,
                name: 'visa',
            ...
            },
            {
                ...
                deposit_time: <Localize translate_text='Instant' />,
                withdrawal_time: <Localize translate_text='1 working day' />,
                description: <Localize translate_text='Deposit and withdraw using your Visa Electron card.' />,
                name: 'VisaElectron',
                // reference: 'visa-payment-method.pdf',
            },
            {
            ...
            },
            {
                ...
                deposit_time: <Localize translate_text='Instant' />,
                withdrawal_time: <Localize translate_text='1 working day. Only for UK clients' />,
                description: <Localize translate_text='Deposit and withdraw using your Maestro debit card.' />,
                name: 'maestro',
            ...
            },
            {
                ...
                deposit_time: <Localize translate_text='Instant' />,
                withdrawal_time: <Localize translate_text='1 working day' />,
                description: <Localize translate_text='Deposit and withdraw using your Diners credit or debit card.' />,
                name: 'diners',
            ...
            },
            {
                ...
                deposit_time: <Localize translate_text='Instant' />,
                withdrawal_time: <Localize translate_text='1 working day' />,
                description: <Localize translate_text='Deposit and withdraw using your JCB credit card.' />,
            },
        ],
        class_name: 'cards',
    },
    {
        name: <Localize translate_text='Credit/debit cards' />,
        note: <Localize translate_text='Withdrawals may take up to 15 working days to reflect on your card.' />,
        is_eu: true,
        data: [
            {
                method: <StyledIcon src={Visa} alt='Visa' />,
            ...
            },
            {
                ...
                deposit_time: <Localize translate_text='Instant' />,
                withdrawal_time: <Localize translate_text='1 working day' />,
                description: <Localize translate_text='Deposit and withdraw funds using your Visa Electron card.' />,
                name: 'VisaElectron',
            },
            {
                method: <StyledIcon src={Maestro} alt='Maestro' />,
                ...
                deposit_time: <Localize translate_text='Instant' />,
                withdrawal_time: <Localize translate_text='1 working day' />,
                description: <Localize translate_text='Deposit and withdraw funds using your Maestro debit card.' />,
                name: 'maestro',
            },
            {
                method: <StyledIcon src={MasterCard} alt='Mastercard' />,
                ...
                description: <Localize translate_text='Deposit funds using your Mastercard credit or debit card.' />,
                name: 'mastercard',
            },
        ],
    },
    ...
    },
    {
        ...
        data: [
            ...
            },
            {
                ...
                deposit_time: <Localize translate_text='Instant' />,
                withdrawal_time: <Localize translate_text='Not applicable' />,
                description: <Localize translate_text='Deposit and withdraw easily in THB, IDR, and VND.' />,
                name: 'DragonPhoenix',
