    ...
    return (
        <CssGrid columns='repeat(2, 1fr)'>
            <CssGridColumn>
                ...
                <GridItem name='_t_Bulgaria_t_' url='/regulatory/countries/Bulgaria.pdf' order='2' />
                ...
                <GridItem name='_t_Czech Republic_t_' url='/regulatory/countries/CzechRepublic.pdf' order='5' />
            ...
            <CssGridColumn>
                ...
                <GridItem name='_t_Lithuania_t_' url='/regulatory/countries/Lithuania.pdf' order='16' />
                <GridItem name='_t_Luxembourg_t_' url='/regulatory/countries/Luxembourg.pdf' order='17' />
                <GridItem name='_t_Netherlands_t_' url='/regulatory/countries/Netherlands.pdf' order='18' />
                <GridItem name='_t_Poland_t_' url='/regulatory/countries/Poland.pdf' order='19' />
                <GridItem name='_t_Portugal_t_' url='/regulatory/countries/Portugal.pdf' order='20' />
                <GridItem name='_t_Romania_t_' url='/regulatory/countries/Romania.pdf' order='21' />
                <GridItem name='_t_Slovakia_t_' url='/regulatory/countries/Slovakia.pdf' order='22' />
                <GridItem name='_t_Slovenia_t_' url='/regulatory/countries/Slovenia.pdf' order='23' />
