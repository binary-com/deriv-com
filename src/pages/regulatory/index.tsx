        ...
        <Layout>
            ...
            <SectionContainer>
                <GridContainer>
                    ...
                    <StyledHeader as='h5' type='paragraph-1' align='center' weight='normal' maxwidth='792px'>
            ...
            <SectionContainer padding='2.4rem 0 0'>
                <SmallContainer fd='column'>
                    <Box padding='0 0 4rem'>
                        <StyledHeader as='h5' type='paragraph-1' align='start' weight='normal' maxwidth='792px'>
                ...
                <SmallContainer>
                    ...
                    >
                        ...
                        <ResponsiveGrid align='flex-start'>
                            ...
                            <Img src={FSC} alt='British Virgin Islands Financial Services Commission' />
                        </ResponsiveGrid>
                        <CssGridColumn>
                            <DesktopWrapper>
                                <StyledHeader as='h2' type='sub-section-title'>
