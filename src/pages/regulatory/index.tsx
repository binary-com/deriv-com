            ...
            <SectionContainer>
                <GridContainer>
                    <ResponsiveHeader as="h1" type="display-title" align="center">
                        {localize('_t_Regulatory information_t_')}
                    </ResponsiveHeader>
                    <StyledHeader
                        as="h5"
                        type="paragraph-1"
                    ...
                    >
                        {localize(
                            '_t_The services offered on Deriv.com are provided by the Deriv Group. The group has several subsidiary companies that are licensed to operate Deriv.com in their registered jurisdictions._t_',
                        )}
                    </StyledHeader>
                    <StyledHeader
                        as="h5"
                    ...
                    >
                        {localize(
                            '_t_Since 1999, the group has served traders around the world with integrity and reliability. We always hold ourselves to the highest ethical standards and regulatory requirements._t_',
                        )}
                    </StyledHeader>
                </GridContainer>
            </SectionContainer>
            ...
            <SectionContainer padding="8rem 0 0">
                <SmallContainer fd="column">
                    <StyledHeader as="h2" type="section-title" align="center" mb="4rem" lh="4rem">
                        {localize('_t_Deriv Investments (Europe) Limited_t_')}
                    </StyledHeader>
                    <Box padding="16px 0" maxwidth="792px">
                        ...
                        <Header as="h3" type="paragraph-1" align="center" weight="normal" mt="2rem">
                            {localize(
                                '_t_Clients in the European Union who wish to trade financial instruments can have accounts under Deriv Investments (Europe) Limited._t_',
                            )}
                        </Header>
                    </Box>
                </SmallContainer>
            ...
            <SectionContainer padding="2.4rem 0 0">
                <SmallContainer fd="column">
                    <Box padding="0 0 4rem">
                        ...
                        >
                            {localize(
                                '_t_Deriv Investments (Europe) Limited is entitled to provide services in any other EU member state through EU passporting rights. Above is a list of the EU countries that have access to Deriv.com via EU passporting rights._t_',
                            )}
                        </StyledHeader>
                    </Box>
                </SmallContainer>
                    ...
                    >
                        ...
                        <CssGridColumn>
                            ...
                            <Text mt="0.8rem" max_width="58.8rem">
                                <Localize
                                    translate_text="_t_Deriv (FX) Ltd – F16, Level 1, Paragon Labuan, Jalan Tun Mustapha, Labuan 87000, Malaysia – is licensed by Labuan Financial Services Authority(<0>licence no. MB/18/0024</0>)._t_"
                                    components={[
                                        <LinkText
                                            key={0}
                                            weight="bold"
                            ...
                            <Text mt="2rem" max_width="58.8rem">
                                {localize(
                                    '_t_Clients in the rest of the world (except for restricted countries such as the USA, Canada, and Hong Kong) who wish to trade CFDs on forex and cryptocurrencies can have DMT5 Financial STP accounts under Deriv (FX) Ltd._t_',
                                )}
                            </Text>
                        </CssGridColumn>
                        ...
                        <CssGridColumn>
                            ...
                            <Text max_width="58.8rem">
                                {localize(
                                    '_t_Clients in the rest of the world (except for certain countries such as the USA, Canada, and Hong Kong) who wish to trade CFDs on financial instruments (via DMT5 Financial account or DMT5 Financial STP account) and synthetic indices (via DMT5 Synthetic account) can have MetaTrader 5 accounts under Deriv (BVI) Ltd._t_',
                                )}
                            </Text>
                        </CssGridColumn>
                        ...
                        <CssGridColumn>
                            ...
                            <Text max_width="58.8rem">
                                {localize(
                                    '_t_Clients in the rest of the world (except for restricted countries such as the USA, Canada, and Hong Kong) who wish to trade CFDs on financial instruments can have DMT5 Financial accounts and Deriv X Financial accounts under Deriv (V) Ltd. This company does not offer CFDs on cryptocurrencies._t_',
                                )}
                            </Text>
                        </CssGridColumn>
                        ...
                        <CssGridColumn>
                            ...
                            <Text mt="0.8rem" mb="1.6rem" max_width="58.8rem">
                                {localize(
                                    '_t_Deriv (SVG) LLC is located in Hinds Buildings, Kingstown, St. Vincent and the Grenadines (company no. 273 LLC 2020)._t_',
                                )}
                            </Text>
                            <Text max_width="58.8rem">
                                {localize(
                ...
                <SmallContainer>
                    ...
                    >
                        <ResponsiveGrid align="flex-start">
                            <MobileWrapper>
                                <StyledHeader as="h2" type="sub-section-title" mb="1.6rem">
                                    {localize('_t_The Financial Commission_t_')}
                                </StyledHeader>
                            </MobileWrapper>
