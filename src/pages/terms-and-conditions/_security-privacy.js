...
export const SecurityAndPrivacy = () => (
    <StyledSection>
        ...
        <StyledHeader as="h4" weight="500">
            {localize('Profiling and categorisation')}
        </StyledHeader>
        <TncText>
            {localize(
        ...
        <StyledHeader as="h4" weight="500">
            {localize('Cookies and device information')}
        </StyledHeader>
        <TncText>
            {localize(
        ...
        <StyledHeader as="h4" weight="500">
            {localize('Notification of changes')}
        </StyledHeader>
        <TncText>
            {localize(
