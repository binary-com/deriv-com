...
const ConflictsPolicyComponent = Hoc(ConflictsPolicy)

const ConflictsPolicyTab = () => {
    return <ConflictsPolicyComponent></ConflictsPolicyComponent>
}

export default WithIntl()(ConflictsPolicyTab)
