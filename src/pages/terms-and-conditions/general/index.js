...
const General = () => {
    return (
        <StyledSection>
            ...
            <StyledHeader as="h4" weight="500" id="Introduction">
                {localize('A.  Introduction and scope of the agreement')}
                <StyledLink to="/terms-and-conditions/general/#Introduction">
            ...
            <StyledHeader as="h4" weight="500" id="Governing">
                {localize('B. Governing laws and jurisdiction')}
                <StyledLink to="/terms-and-conditions/general/#Governing">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
            ...
            <StyledHeader as="h4" weight="500" id="Communication">
                {localize('C. Communication')}
                <StyledLink to="/terms-and-conditions/general/#Communication">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
            ...
            <StyledHeader as="h4" weight="500" id="Account">
                {localize('D. Account Management')}
                <StyledLink to="/terms-and-conditions/general/#Account">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
            ...
            <StyledHeader as="h4" weight="500" id="Trades">
                {localize('E. Trades')}
                <StyledLink to="/terms-and-conditions/general/#Trades">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
                ...
                <li>
                    <TncListText>
                        {localize('Rules and Restrictions')}
                    </TncListText>
                    <StyledOrder type="lower-alpha">
                        <li>
                            <TncListText>
            ...
            <StyledHeader as="h4" weight="500" id="Client">
                {localize('F. Client funds')}
                <StyledLink to="/terms-and-conditions/general/#Client">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
            ...
            <StyledHeader as="h4" weight="500" id="Fraud">
                {localize('G. Fraud and money laundering')}
                <StyledLink to="/terms-and-conditions/general/#Fraud">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
            ...
            <StyledHeader as="h4" weight="500" id="Rights">
                {localize('H. Our rights')}
                <StyledLink to="/terms-and-conditions/general/#Rights">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
            ...
            <StyledHeader as="h4" weight="500" id="Liability">
                {localize('I. Liability')}
                <StyledLink to="/terms-and-conditions/general/#Liability">#</StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
                <li>
            ...
            <StyledHeader as="h4" weight="500" id="Force">
                {localize('K. Force Majeure')}
                <StyledLink to="/terms-and-conditions/general/#Force">
                    <AnchorSpan>#</AnchorSpan>
                </StyledLink>
            </StyledHeader>
            <StyledOrder type="decimal">
...
const GeneralComponent = Hoc(General)

const GeneralTab = () => {
    return <GeneralComponent></GeneralComponent>
}

export default WithIntl()(GeneralTab)
