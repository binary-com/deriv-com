...
const OrderExecutionComponent = Hoc(OrderExecution)

const OrderExecutionTab = () => {
    return <OrderExecutionComponent></OrderExecutionComponent>
}

export default WithIntl()(OrderExecutionTab)