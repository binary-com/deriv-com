...
const PaymentAgentsComponent = Hoc(PaymentAgents)

const PaymentAgentsTab = () => {
    return <PaymentAgentsComponent></PaymentAgentsComponent>
}

export default WithIntl()(PaymentAgentsTab)