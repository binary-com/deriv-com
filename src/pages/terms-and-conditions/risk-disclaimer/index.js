...
const RiskDisclaimerComponent = Hoc(RiskDisclaimer)

const RiskDisclaimerTab = () => {
    return <RiskDisclaimerComponent></RiskDisclaimerComponent>
}

export default WithIntl()(RiskDisclaimerTab)