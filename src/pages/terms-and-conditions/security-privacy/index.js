...
const SecurityAndPrivacyComponent = Hoc(SecurityAndPrivacy)

const SecurityAndPrivacyTab = () => {
    return <SecurityAndPrivacyComponent></SecurityAndPrivacyComponent>
}

export default WithIntl()(SecurityAndPrivacyTab)
