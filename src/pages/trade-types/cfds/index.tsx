...
const lazy_components = (
    <>
        <WhatIsCFD
            fallback={
                <div>
                    <img src={CFD_DUMMY} style={{ width: '95%' }} alt="what-is-cfd" />
                </div>
            }
        />
        <ThingsToKeep
            fallback={
                <div>
                    <img src={CFD_DUMMY} style={{ width: '95%' }} alt="things-to-keep" />
                </div>
            }
        />
        <TradingCFDIncreases
            fallback={
                <div>
                    <img src={CFD_TRADE_DUMMY} style={{ width: '95%' }} alt="cfd-trades" />
                </div>
            }
        />
        ...
        <WhyTradeCFD
            fallback={
                <div>
                    <img src={WHY_DUMMY} style={{ width: '95%' }} alt="why-cfd" />
                </div>
            }
        />
        <StartTrading
            fallback={
                <div>
                    <img src={START_DUMMY} style={{ width: '95%' }} alt="start-cfd" />
                </div>
            }
        />
        <AvailableMarkets
            fallback={
                <div>
                    <img src={CFD_MARKETS_DUMMY} style={{ width: '95%' }} alt="cfd-markets" />
                </div>
            }
        />
    </>
