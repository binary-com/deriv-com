    ...
    return (
        <SectionContainer background="rgba(242, 243, 244, 0.3)" padding="4rem 0 4rem">
            <SmallContainer direction="column" ai="flex-start">
                ...
                <Grid>
                    <WhyTradeItem>
                        <img src={HighLeverge} alt={localize('_t_High leverage, low spreads_t_')} />
                    ...
                    <WhyTradeItem>
                        <img src={SyntheticIndices} alt={localize('_t_Synthetic Indices_t_')} />
                        <Text weight="bold" mb="0.8rem" mt="1.6rem">
                    ...
                    <WhyTradeItem>
                        <img
                            src={MaximizePotentialProfit}
                            alt={localize('_t_Maximize Potential Profit_t_')}
                        />
                        <Text weight="bold" mb="0.8rem" mt="1.6rem">
                    ...
                    <WhyTradeItem>
                        <img src={FriendlySupport} alt={localize('_t_Friendly Support_t_')} />
                        <Text weight="bold" mb="0.8rem" mt="1.6rem">
                    ...
                    <WhyTradeItem>
                        <img src={InstantAccess} alt={localize('_t_Instant access_t_')} />
                        <Text weight="bold" mb="0.8rem" mt="1.6rem">
