        ...
        <SectionContainer padding="4rem 0 4rem">
            <SmallContainer fd="column" jc="flex-start">
                ...
                <Text mb="3.2rem">
                    {is_eu
                        ? localize(
                              "Deal cancellation isn't available for Crash and Boom indices or cryptocurrency pairs. The stop out feature will close your contract automatically when your loss reaches or exceeds a percentage of your stake. The stop out percentage is shown below your stake on Deriv Trader and varies according to your chosen multiplier.",
                          )
                        : localize(
                              'Deal cancellation isn’t available for Crash and Boom indices. The stop-out feature will close your contract automatically when your loss reaches or exceeds a percentage of your stake. The stop-out percentage is shown below your stake on Deriv Trader and varies according to your chosen multiplier.',
                          )}
                </Text>
                <Header as="h4" type="sub-section-title" mb="0.8rem">
                    {localize(
                ...
                <Text mb="3.2rem">
                    {is_eu
                        ? localize(
                              'This is to protect you from losing your money when using deal cancellation. With deal cancellation, you are allowed to reclaim your full stake amount (minus a small fee) if you cancel your contract within an hour of opening the position. Stop loss, on the other hand, will close your contract at a loss if the market moves against your position. However, once the deal cancellation expires, you can set a stop loss level on the open contract.',
                          )
                        : localize(
