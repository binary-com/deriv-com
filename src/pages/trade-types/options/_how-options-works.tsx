            ...
            <SmallContainer direction="column" ai="flex-start">
                ...
                <SideTab>
                    <SideTab.Panel
                        ...
                        description={{
                            text: '_t_Choose from forex, stocks & indices, commodities, derived._t_',
                        }}
                    >
                        <QueryImage
                    ...
                    <SideTab.Panel
                        ...
                        description={{
                            text: '_t_Select your desired trade type – Up and Down, High and Lows, Digits, etc._t_',
                        }}
                    >
                        <QueryImage data={data['option_trade_type']} alt="Select trade type" />
                    </SideTab.Panel>
                    <SideTab.Panel
                        label={{ text: '_t_3. Duration_t_' }}
                        description={{
                            text: '_t_Set the duration of your trade. Depending on whether you have a short-term or long-term view of the markets, you can set your preferred duration, starting from 1 to 10 ticks or 15 seconds to 365 days._t_',
                        }}
                    >
                        <QueryImage data={data['option_duration']} alt="Select trade duration" />
                    </SideTab.Panel>
                    <SideTab.Panel
                        label={{ text: '_t_4. Stake_t_' }}
                        description={{
                            text: '_t_Enter your stake amount to receive a payout quote instantly. Alternatively, you can set your preferred payout to receive a price quote for a corresponding stake amount._t_',
                        }}
                    >
                        <QueryImage
                ...
                <SideTab is_reverse>
                    <SideTab.Panel
                        label={{ text: '_t_5. Get quote_t_' }}
                        description={{
                            text: '_t_Based on the position you’ve defined, you’ll instantly receive a payout quote or a quote of the stake required to open your position._t_',
                        }}
                    >
                        <QueryImage
                ...
                <SideTab>
                    <SideTab.Panel
                        label={{ text: '_t_6. Purchase your contract_t_' }}
                        description={{
                            text: '_t_Place your order immediately if you are satisfied with the quote that you’ve received.  Otherwise, continue to customise the parameters and purchase your contract when you are comfortable with the quote._t_',
                        }}
                    >
