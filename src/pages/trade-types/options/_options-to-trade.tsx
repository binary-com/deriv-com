...
// SVG
import RiseFall from 'images/svg/options/option_rise_fall.svg'
import HigherLower from 'images/svg/options/option_higher_lower.svg'
import EbEo from 'images/svg/options/option_eb_eo.svg'
import SbGo from 'images/svg/options/option_sb_go.svg'
import MatchDiffers from 'images/svg/options/option_matches_differs.svg'
import EvenOdd from 'images/svg/options/option_even_odd.svg'
import OverUnder from 'images/svg/options/option_over_under.svg'
import RcRp from 'images/svg/options/option_rc_rp.svg'
import HighLowTicks from 'images/svg/options/option_hl_ticks.svg'
import TnT from 'images/svg/options/option_tnt.svg'
import Asians from 'images/svg/options/option_asians.svg'
import OuOd from 'images/svg/options/option_ou_od.svg'
import HighClose from 'images/svg/options/option_high_close.svg'
import CloseLow from 'images/svg/options/option_close_low.svg'
import HighLow from 'images/svg/options/option_high_low.svg'
