...
const query = graphql`
    query {
        ...
        margin_mobile: file(relativePath: { eq: "trade-tools/landing/margin-calculator-mobile.png" }) {
            ...fadeIn
        }
        ...
        pnl_multipliers_mobile: file(relativePath: { eq: "trade-tools/landing/pnl-multipliers-mobile.png" }) {
            ...fadeIn
        }
    }
`;
