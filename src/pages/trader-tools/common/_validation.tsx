...
const validation_regex_number = maxDigit => new RegExp(`^\\d{0,${maxDigit}}\\.?\\d{0,${maxDigit}}$`);
...
const numberValidation = (input, fieldName, maxDigit) => {
    if (!input) {
        ...
        return localize('_t_Please enter a valid amount, including the decimal point (.), in this format: ####.#_t_');
