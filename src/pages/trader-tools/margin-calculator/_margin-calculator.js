...
import { Text, QueryImage, Dropdown } from 'components/elements'
    ...
    return (
        <StyledSection direction="column">
            <Text padding="0rem 0rem 6rem 32rem">
                <Localize
                    translate_text="Trader`s tools > <0> Margin Calculator</0>"
                    components={[<strong key={0} />]}
                ></Localize>
            </Text>
            <Text size="var(--text-size-m)" mt="1rem" align="center">
                {localize(
                    'Our margin calculator helps you to estimate the margin required to keep',
                )}
            </Text>
            <Text size="var(--text-size-m)" align="center">
                {localize('your positions open overnight on Deriv MetaTrader 5 (DMT5).')}
            </Text>
            <ContentContainer mb="4.0rem" mt="8rem">
                <FormWrapper>
                    <Formik
                        enableReinitialize
                        initialValues={{
            ...
            <BottomContent direction="column">
                <BottomText mb="2.4rem">
                    <Localize
                        translate_text="To view the asset price, go to DMT5, click on the <0>View </0> tab and select<0> Market Watch</0>. Then right-click on the symbol you want to trade and select <0>Specification.</0>"
                        components={[<strong key={0} />]}
                    />
                </BottomText>
