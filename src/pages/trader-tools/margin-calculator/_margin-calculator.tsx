...
import EuCalculation from './eu-calculation'
...
const MarginCalculator = () => {
    ...
    const leverageList = is_eu ? leverageItemListsEU : leverageItemLists
    const marketList = is_eu ? euMarketData : syntheticItemLists
                    ...
                    <RightContent>
                        ...
                        {is_eu ? (
                            <>
                                <Text mb="20px">
                                    {localize(
                                        'For instance, if you are trading the USD/CHF forex pair, the margin requirement will be calculated in Swiss Franc (CHF) which is the quote currency. On the other hand, if you are trading Volatility 200 (1s) Index, then the margin requirement will be calculated in US Dollar (USD), which is the denomination of the underlying asset – Volatility 200 (1s) Index.',
                                    )}
                                </Text>
                                <Text mb="40px">
                                    {localize(
                                        'The above formula is applicable for all instruments except for forex, cryptocurrencies, and stocks. For other markets on the Deriv MT5 platform, go to Margin calculation.',
                                    )}
                                </Text>
                            </>
                        ) : (
                        ...
                        <Accordion has_single_state>
                            ...
                            >
                                {is_eu ? (
                                    <Text mb="16px">
                                        {localize(
                                            'Let’s say you want to trade two lots of EUR/USD with an asset price of 1.10 USD and leverage of 30.',
                                        )}
                                    </Text>
                                ) : (
                                    <Text mb="16px">
                                ...
                                <Text mb="1.6rem" mt="1.6rem">
                                    {is_eu ? (
                                        <Localize
                                            translate_text="So you will require a margin rate of <0>7,333 USD</0> to open the above position."
                                            components={[<strong key={0} />]}
                                        />
                                    ) : (
                                        <Localize
