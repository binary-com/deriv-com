            ...
            <Desktop>
                <FormulaContainer height='176px'>
                    <FormulaHighlight jc='space-evenly' pl='30px' pr='30px'>
                        ...
                        <FormulaValueSwapSynthetic>
                            <Localize translate_text='_t_<0>1.1750</0>_t_' components={[<FormulaGreen key={0} />]} />
            ...
            <Desktop>
                <FormulaContainer height='176px'>
                    <FormulaHighlight jc='space-evenly' pr='76px' pl='76px'>
                        ...
                        <FormulaValueSwapSynthetic>
                            <Localize translate_text='_t_<0>24</0>_t_' components={[<FormulaGreen key={0} />]} />
            ...
            <Desktop breakpoint='tablet'>
                <FormulaContainer height='176px'>
                    <FormulaHighlight pr='45px' pl='45px'>
                        ...
                        <FormulaValue>
                            <Localize translate_text='_t_<0>221.5961</0>_t_' components={[<FormulaGreen key={0} />]} />
            ...
            <Desktop>
                <FormulaContainer height='176px'>
                    <FormulaHighlight jc='space-evenly' pl='41px' pr='41px'>
                        ...
                        <FormulaValueSwapSynthetic>
                            <Localize translate_text='_t_<0>280,000</0>_t_' components={[<FormulaGreen key={0} />]} />
