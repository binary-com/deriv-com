            ...
            <Desktop>
                <FormulaContainer height="176px">
                    <FormulaHighlight>
                        ...
                        <FormulaValueSwapSynthetic>
                            <Localize translate_text="( 10" />
                            <PointerContainer top ml="115px">
                                <PointerDot ml="-245px" />
                                <PointerStick ml="-245px" height="10px" />
                                <PointerStickHorizontal w="125px" ml="-121px" />
                                <PointerStick ml="1px" height="15px" />
                                <PointerText>
                                    <Localize translate_text="Stake" />
                                </PointerText>
                            </PointerContainer>
                        ...
                        <FormulaTopWrapperPnl mt="29px">
                            ...
                            <FormulaValue>
                                ...
                                <PointerContainer ml="-20px" top width="100px">
                                    <PointerDot ml="-37px" />
                                    <PointerStick height="6px" ml="-38px" />
                                    <PointerStickHorizontal w="95px" ml="55px" />
                                </PointerContainer>
                            </FormulaValue>
