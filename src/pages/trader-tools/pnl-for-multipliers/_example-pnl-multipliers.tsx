            ...
            <Desktop>
                <FormulaContainer height='176px'>
                    <FormulaHighlight>
                        ...
                        <FormulaValueSwapSynthetic>
                            <Localize translate_text='_t_<0>3351.46</0>_t_' components={[<FormulaGreen key={0} />]} />
            ...
            <Desktop>
                <FormulaContainer height='176px'>
                    <FormulaHighlight>
                        ...
                        <FormulaValueSwapSynthetic>
                            <Localize translate_text='_t_<0>3350.11</0>_t_' components={[<FormulaGreen key={0} />]} />
                            <PointerContainer width='100px' ml='-30px'>
                                <PointerDot />
                                <PointerStick />
                                <PointerText>
                ...
                <FormulaContainer height='227px' pt='0'>
                    <FormulaHighlightForPnlMultiplier height='110px' mt='60px' mb='60px'>
                        ...
                        <FormulaBottomWrapperPnl>
                            ...
                            <FormulaValue mb='0'>
                                <Localize translate_text='_t_<0>6.83</0>_t_' components={[<FormulaGreen key={0} />]} />
                ...
                <FormulaContainer height='227px' pt='0'>
                    <FormulaHighlightForPnlMultiplier height='110px' mt='60px' mb='60px'>
                        ...
                        <FormulaBottomWrapperPnl>
                            ...
                            <FormulaValue mb='0'>
                                <Localize translate_text='_t_<0>-7.23</0>_t_' components={[<FormulaGreen key={0} />]} />
                                <PointerContainer width='100px' ml='-30px'>
                                    <PointerDot />
                                    <PointerStick height='32px' />
                                    <PointerText ml='-25px'>
