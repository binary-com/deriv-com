...
import { StopLossLevelUp, TakeProfitLevelUp, TakeProfitAmountUp, StopLossAmountDown } from './_example-pnl-multipliers';
import { localize, Localize } from 'components/localization';
import { Accordion, AccordionItem, Header, LocalizedLinkText, ImageWithDireciton, Text } from 'components/elements';
...
const AssetPriceField = ({
    ...
    <Field name='assetPrice' value={values.assetPrice} onChange={value => setFieldValue('assetPrice', value)}>
        {({ field }) => (
            <Input
                {...field}
                id='assetPrice'
...
const StakeField = ({
    ...
    <Field name='stake' value={values.stake} onChange={set_field_value_stake_change_handler(setFieldValue)}>
        {({ field }) => (
            <Input
                {...field}
                id='stake'
...
const PnlMultipliersCalculator = () => {
    ...
    const mainAssetPriceErrorHandler = (setFieldValue, setFieldError, setFieldTouched) => current_input => {
    ...
    const mainMultiplierErrorHandler = (setFieldValue, setFieldError, setFieldTouched) => current_input => {
    ...
    const mainCommissionErrorHandler = (setFieldValue, setFieldError, setFieldTouched) => current_input => {
    ...
    const mainStakeErrorHandler = (setFieldValue, setFieldError, setFieldTouched) => current_input => {
    ...
    return (
        <>
            ...
            <StyledSection direction='column'>
                ...
                <Flex mt='80px' mb='40px' tablet={{ mt: '40px', mb: '24px' }} id='pnl-multipliers-tab-selector'>
                                ...
                                onSubmit={(values, { setFieldValue }) => {
                                    setFieldValue(
                                        ...
                                        sub_tab === 'Up'
                                            ...
                                            : getPnlMultiplierCommon(values, 'getTakeProfitLevelDown')
                                    );
                                    setFieldValue(
                                        'stopLossLevelOutput',
                                        sub_tab === 'Up'
                                    ...
                                    setFieldValue('takeProfitAmount', numberSubmitFormat(values.takeProfitAmount));
                                    setFieldValue('stopLossAmount', numberSubmitFormat(values.stopLossAmount));
                                }}
                            >
                                {({
                                    values,
                                                            ...
                                                            <Flex fd='column' width='23.4rem'>
                                                                <PnLInputGroup>
                                                                    <AssetPriceField
                                                                        ...
                                                                        assetPriceErrorHandler={assetPriceErrorHandler}
                                                                    />
                                                                </PnLInputGroup>
                                                            </Flex>
                                                            <Flex fd='column' width='23.4rem'>
                                                                <PnLInputGroup>
                                                                    <CommissionField
                                                                        ...
                                                                        errors={errors}
                                                                        handleBlur={handleBlur}
                                                                        commissionErrorHandler={commissionErrorHandler}
                                                                    />
                                                                </PnLInputGroup>
                                                            </Flex>
                                                        </Flex>
                                                            ...
                                                            <Flex fd='column' width='23.4rem'>
                                                                <PnLInputGroup>
                                                                    <StakeField
                                                                        ...
                                                                        errors={errors}
                                                                        handleBlur={handleBlur}
                                                                        stakeErrorHandler={stakeErrorHandler}
                                                                    />
                                                                </PnLInputGroup>
                                                            </Flex>
                                                            <Flex fd='column' width='23.4rem'>
                                                            ...
                                                            <Flex fd='column' width='23.4rem'>
                                                                <PnLInputGroup>
                                                                    <MultiplierField
                                                                        ...
                                                                        errors={errors}
                                                                        handleBlur={handleBlur}
                                                                        multiplierErrorHandler={multiplierErrorHandler}
                                                                    />
                                                                </PnLInputGroup>
                                                            </Flex>
                                                            <Flex fd='column' width='23.4rem'>
                                                    ...
                                                    <CalculatorBody>
                                                            ...
                                                            >
                                                                {({ field }) => (
                                                                    <Input
                                                                        ...
                                                                        onBlur={handleBlur}
                                                                        data-lpignore='true'
                                                                        handleError={takeProfitAmountErrorHandler}
                                                                        maxLength={getMaxLength(
                                                                            values.takeProfitAmount,
                                                                            15
                                                                        )}
                                                        ...
                                                        <InputGroup>
                                                            <StopLossAmountField
                                                                ...
                                                                errors={errors}
                                                                handleBlur={handleBlur}
                                                                stopLossAmountErrorHandler={stopLossAmountErrorHandler}
                                                            />
                                                        </InputGroup>
                            ...
                            <Formik
                                ...
                                onSubmit={(values, { setFieldValue }) => {
                                    setFieldValue(
                                        ...
                                        sub_tab === 'Up'
                                            ? getPnlMultiplierCommon(values, 'getTakeProfitAmountUp')
                                            : getPnlMultiplierCommon(values, 'getTakeProfitAmountDown')
                                    );
                                    setFieldValue(
                                        'stopLossAmountOutput',
                                        sub_tab === 'Up'
                                            ? getPnlMultiplierCommon(values, 'getStopLossAmountUp')
                                            : getPnlMultiplierCommon(values, 'getStopLossAmountDown')
                                    );
                                    setFieldValue('assetPrice', numberSubmitFormat(values.assetPrice));
                                    setFieldValue('commission', numberSubmitFormat(values.commission));
                                    setFieldValue('stake', numberSubmitFormat(values.stake));
                                    setFieldValue('multiplier', numberSubmitFormat(values.multiplier));
                                    setFieldValue('takeProfitLevel', numberSubmitFormat(values.takeProfitLevel));
                                    setFieldValue('stopLossLevel', numberSubmitFormat(values.stopLossLevel));
                                }}
                            >
                                {({
                                    values,
                                                    ...
                                                    <CalculatorBody>
                                                            ...
                                                            >
                                                                {({ field }) => (
                                                                    <Input
                                                                        ...
                                                                        type='text'
                                                                        value={values.takeProfitLevel}
                                                                        label={localize('_t_Take profit level_t_')}
                                                                        autoComplete='off'
                                                                        error={
                                                                            touched.takeProfitLevel &&
                                                                            errors.takeProfitLevel
                                                                        ...
                                                                        onBlur={handleBlur}
                                                                        data-lpignore='true'
                                                                        handleError={takeProfitLevelErrorHandler}
                                                                        maxLength={getMaxLength(
                                                                            values.takeProfitLevel,
                                                                            15
                                                                        )}
                                                        ...
                                                        <InputGroup>
                                                            <StopLossLevelField
                                                                ...
                                                                errors={errors}
                                                                handleBlur={handleBlur}
                                                                stopLossLevelErrorHandler={stopLossLevelErrorHandler}
                                                            />
                                                        </InputGroup>
