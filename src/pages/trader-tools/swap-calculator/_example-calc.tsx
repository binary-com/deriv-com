                ...
                <FormulaContainerMobile height="188px">
                    <FormulaHighlightMobile height="82px" syn_mobile>
                        <FormulaTopWrapper>
                            ...
                            <FormulaValueMobile>
                                <Localize translate_text="1" />
                                <PointerContainerMobile mw="0" ml="-38px">
                                    <PointerDotMobile />
                                    <PointerStickMobile height="60px" />
                                    <PointerTextMobile>
                                        <Localize
                        ...
                        <FormulaBottomWrapper ml="30px">
                            ...
                            <FormulaValueMobile>
                                <Localize
                                    ...
                                    components={[<FormulaGreen key={0} />]}
                                />
                                <PointerContainerMobile ml="-25px" mw="0">
                                    <PointerDotMobile />
                                    <PointerStickMobile />
                                    <PointerTextMobile>
                                        <Localize translate_text="Swap charge" />
                ...
                <FormulaContainer>
                    <FormulaHighlight>
                        ...
                        <FormulaValueSwapSynthetic>
                            ...
                            <PointerContainer ml="-14px" width="100px">
                                <PointerDot />
                                <PointerStick />
                                <PointerText top>
                                    <Localize
                ...
                <FormulaContainerMobile height="178px">
                    <FormulaHighlightMobile height="82px" syn_mobile>
                        <FormulaTopWrapper>
                            <FormulaValueMobile>
                                <Localize translate_text="2" />
                                <PointerContainerMobile mw="0" ml="-15">
                                    <PointerDotMobile />
