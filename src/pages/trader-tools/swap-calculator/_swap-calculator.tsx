    ...
    return (
        <>
            ...
            <StyledSection direction='column'>
                ...
                <Flex mt='80px' mb='40px' tablet={{ mt: '40px', mb: '24px' }} id='swap-tab-selector'>
                    <SwapTabSelector active={tab === 'Synthetic'} onClick={() => onTabClick('Synthetic')}>
                                    ...
                                    {({
                                        ...
                                        <CalculatorForm>
                                            <CalculatorHeader>
                                                ...
                                                <CalculatorOutputContainer>
                                                    <CalculatorOutputField>{values.swapCharge}</CalculatorOutputField>
                                                    <CalculatorOutputSymbol>
                                        ...
                                        <CalculatorForm>
                                            ...
                                            <CalculatorBody>
                                                <Dropdown
                                                    ...
                                                    selected_option={values.symbol}
                                                    id='symbol'
                                                    onChange={swap_currency_change_handler(setFieldValue)}
                                                    contractSize={values.contractSize}
                                                    error={touched.symbol && errors.symbol}
                                                    onBlur={handleBlur}
                                                />
