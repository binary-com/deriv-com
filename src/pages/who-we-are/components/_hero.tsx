...
const Hero = ({ hero }: THero) => {
    ...
    const bg_image = is_mobile_or_tablet ? hero?.bg_mobile.localFile?.publicURL : hero?.bg_desktop.localFile?.publicURL;
    ...
    return (
        <ParentWrapper bg_image={bg_image}>
            <ContentWrapper jc='center'>
                <Desktop>
                    <StyledFlex>
                        <StyledImage src={hero?.hero_image.localFile?.publicURL} alt='hero image desktop' />
                ...
                <Mobile>
                    <Flex fd='column' ai='center' p='0 16px'>
                        <StyledMobileImage src={hero?.hero_image.localFile?.publicURL} alt='hero image mobile' />
                        <MobileHeader>
                            <Localize translate_text={hero?.header} />
                        </MobileHeader>
                    </Flex>
