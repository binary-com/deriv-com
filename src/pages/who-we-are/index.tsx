...
import { DerivNumbers, OurLeadership, OurOffices, OurPrinciples, OurValues, WhoWeAreBanner } from './_lazy-load';
...
const WhoWeAre = ({ data }: TWhoWeAre) => {
    const { hero, our_values, our_principles, our_leadership, deriv_in_numbers, slider_medias, our_locations, banner } =
