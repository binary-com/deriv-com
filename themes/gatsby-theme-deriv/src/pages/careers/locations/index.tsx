...
const query = graphql`
    query {
        ...
        thumbnail_roadtown: file(relativePath: { eq: "careers/thumbnail_roadtown.jpg" }) {
            ...fadeIn
        }
        ...
        thumbnail_hongkong: file(relativePath: { eq: "careers/thumbnail_hongkong.png" }) {
            ...fadeIn
        }
        thumbnail_london: file(relativePath: { eq: "careers/thumbnail_london.jpg" }) {
            ...fadeIn
        thumbnail_senegal: file(relativePath: { eq: "careers/thumbnail_senegal.png" }) {
            ...fadeIn
        }
    }
`
