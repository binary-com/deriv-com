...
export const accumulators_indices: TMarketSymbol[] = [
    {
...
export const continuous_indices: TMarketSymbol[] = [
    {
        src: icons.INDEX10S1NEW,
        text: '_t_Volatility 10 (1s) Index_t_',
    },
...
export const continuous_indices_options: TMarketSymbol[] = [
    {
        src: icons.INDEX10S1NEW,
        text: '_t_Volatility 10 (1s) Index_t_',
    },
...
// export const volatility_indices: TMarketSymbol[] = continuous_indices

export const volatility_indices: TMarketSymbol[] = [
    {
        src: icons.INDEX10S1NEW,
        text: '_t_Volatility 10 (1s) Index_t_',
    },
...
export const volatility_indices_c_trader: TMarketSymbol[] = [
    {
        src: icons.VINDEX15S1,
        text: '_t_Volatility 15 (1s) Index_t_',
    },
    {
        src: icons.VINDEX30S1,
        text: '_t_Volatility 30 (1s) Index_t_',
    },
    {
        src: icons.VINDEX90S1,
        text: '_t_Volatility 90 (1s) Index_t_',
    },
]
export const step_indices_derivx: TMarketSymbol[] = [
    {
        src: icons.STEPINDICIESMT5_100,
        text: '_t_Step 100_t_',
    },
]
export const step_indices_mt5: TMarketSymbol[] = [
    ...
    {
        src: icons.STEPINDICIESMT5_200,
        text: '_t_Step 200_t_',
    },
    {
        src: icons.STEPINDICIESMT5_500,
        text: '_t_Step 500_t_',
    },
]
...
export const step_indices_ctrader: TMarketSymbol[] = [
    {
        src: icons.STEPINDICIESCTRDER_300,
        text: '_t_Step 300_t_',
    },
    {
        src: icons.STEPINDICIESCTRDER_400,
        text: '_t_Step 400_t_',
    },
]
...
export const crash_boom_ctrader: TMarketSymbol[] = [
    ...
    {
        src: icons.CRASHI900,
        text: '_t_Crash 900 Index_t_',
    },
    {
        src: icons.BOOMI600,
        text: '_t_Boom 600 Index _t_',
    },
    {
        src: icons.BOOMI900,
        text: '_t_Boom 900 Index _t_',
    },
]

export const crash_boom_multipliers: TMarketSymbol[] = [
    {
        src: icons.BOOM1000NEW,
        text: '_t_Boom 1000 Index_t_',
    },
...
export const crash_boom_eu: TMarketSymbol[] = [
    {
        src: icons.VCRASHIC300,
        text: '_t_Crash 300 Index_t_',
    },
...
export const europe: TMarketSymbol[] = [
    {
...
export const exotic_pairs: TMarketSymbol[] = [
    {
        src: icons.AUDSGD,
        text: '_t_AUD/SGD_t_',
    },
...
export const major_pairs: TMarketSymbol[] = [
    {
        src: icons.AUDJPY,
        text: '_t_AUD/JPY_t_',
    },
...
export const metals: TMarketSymbol[] = [
    {
...
export const metals_options: TMarketSymbol[] = [
    {
        src: icons.GOLDUSD,
        text: '_t_Gold/USD_t_',
    },
...
export const micro_pairs: TMarketSymbol[] = [
    {
        src: icons.AUDCAD,
        text: '_t_AUD/CAD_t_',
    },
...
export const smart_gold_index: TMarketSymbol[] = [
    {
        src: icons.GOLDUSD,
...
export const minor_pairs: TMarketSymbol[] = [
    {
        src: icons.AUDCAD,
        text: '_t_AUD/CAD_t_',
    },
...
export const minor_options_pairs: TMarketSymbol[] = [
    {
        src: icons.AUDCAD,
        text: '_t_AUD/CAD_t_',
    },
...
export const stocks_american_indices: TMarketSymbol[] = [
    {
        src: icons.STOCKSUS500,
        text: '_t_US 500_t_',
    },
...
export const stocks_european_indices: TMarketSymbol[] = [
    {
        src: icons.STOCKSEUROPE50,
        text: '_t_Europe 50_t_',
        eu: true,
...
export const american_stocks: TMarketSymbol[] = [
    {
...
export const cryptocurrencies_trade_type: TMarketSymbol[] = [
    {
        src: icons.BTCUSD,
        text: '_t_BTC/USD_t_',
    },
...
export const cryptocurrencies_cfds: TMarketSymbol[] = [
    {
        src: icons.ALGORAND,
        text: '_t_ALG/USD_t_',
    },
...
export const cryptocurrencies_multipliers: TMarketSymbol[] = [
    {
        src: icons.BTCUSD,
        text: '_t_BTC/USD_t_',
    },
...
export const jump_indices: TMarketSymbol[] = [
    {
        src: icons.JUMP10NEW,
...
export const energy: TMarketSymbol[] = [
    {
...
export const energy_options: TMarketSymbol[] = [
    {
        src: icons.USDBRENT,
        text: '_t_Oil/USD_t_',
    },
]
export const volatility_indices_trade_type_eu: TMarketSymbol[] = []

export const crash_boom_trade_type_eu: TMarketSymbol[] = [
    {
...
export const swap_free_pairs: TMarketSymbol[] = [
    {
        src: icons.AUDCAD,
        text: '_t_AUD/CAD_t_',
    },
...
export const basket_indices_cfds: TMarketSymbol[] = [
    {
        src: icons.AUDBASKET,
...
export const basket_indices_commodities: TMarketSymbol[] = [
    {
...
export const step_indices: TMarketSymbol[] = [
    {
...
export const derived_fx: TMarketSymbol[] = [
    {
        src: icons.GBPUSD10,
